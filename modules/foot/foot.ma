...
//Name: foot.ma
//Last modified: Mon, Jul 28, 2025 10:31:50 AM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "AA0EFA1E-413D-8FE0-F8E3-068767F237AA";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 12.593369202853239 8.1687067516518841 6.81400181777021 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 16.183728544895782;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F09D6D62-442E-7FA8-D0F6-40A745AADA04";
	setAttr -s 23 ".lnk";
	setAttr -s 23 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "3584E58C-4BA5-3C29-56B7-2E84F010F33F";
createNode displayLayer -n "defaultLayer";
	rename -uid "19CE01F8-4DF6-369B-03C9-E4ACC39F3E53";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "30F2EFD4-44EF-71C0-A405-9F892E6A25F4";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1C1467EA-4D0A-64E7-0A7D-56A2415761CD";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C7ECCDD5-473D-7219-17D2-3982EDD6BD20";
