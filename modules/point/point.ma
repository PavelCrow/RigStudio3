...
//Name: point.ma
//Last modified: Tue, Jan 30, 2024 09:43:08 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "53CD0102-48E9-C8D1-89F5-9D9A3B689341";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.304640318319992 12.566395347773822 17.11454495303952 ;
	setAttr ".r" -type "double3" -33.600000000002105 32.400000000000027 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 23.228576841340161;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "9D1FC032-4D6D-37DE-C189-BAAD0B4FF8A8";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "A4622115-4FF0-5603-4006-50A0EB65E65B";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "608EB308-46FB-D543-E6CD-2D9891EB68BD";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "776C6F68-491D-C24F-40AB-0F890306EC47";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "35BC0C09-4786-C5B4-078A-4EA549E09B75";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "48503161-4E8F-B0A6-93D5-719BA27769B1";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -1406.6391382443767 -1133.3332882987145 ;
	setAttr ".tgi[0].vh" -type "double2" 1991.1629245412978 -213.09522962759439 ;
	setAttr -s 6 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 499.74789428710938;
	setAttr ".tgi[0].ni[0].y" -352.60504150390625;
	setAttr ".tgi[0].ni[0].nvs" 18305;
	setAttr ".tgi[0].ni[1].x" -333.18215942382812;
	setAttr ".tgi[0].ni[1].y" -283.27438354492188;
	setAttr ".tgi[0].ni[1].nvs" 18305;
	setAttr ".tgi[0].ni[2].x" 150.8514404296875;
	setAttr ".tgi[0].ni[2].y" -323.61053466796875;
	setAttr ".tgi[0].ni[2].nvs" 18305;
	setAttr ".tgi[0].ni[3].x" 340.92437744140625;
	setAttr ".tgi[0].ni[3].y" -652.85711669921875;
	setAttr ".tgi[0].ni[3].nvs" 18304;
	setAttr ".tgi[0].ni[4].x" -151.93276977539062;
	setAttr ".tgi[0].ni[4].y" -538.1512451171875;
	setAttr ".tgi[0].ni[4].nvs" 18305;
	setAttr ".tgi[0].ni[5].x" 315.71429443359375;
	setAttr ".tgi[0].ni[5].y" -812.85711669921875;
	setAttr ".tgi[0].ni[5].nvs" 18304;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -2649.5878068027528 -445.23807754592212 ;
	setAttr ".tgi[1].vh" -type "double2" 2774.5878018356993 1023.8094831269919 ;
	setAttr -s 14 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" 828.5714111328125;
	setAttr ".tgi[1].ni[0].y" -60;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" 521.4285888671875;
	setAttr ".tgi[1].ni[1].y" 398.57144165039062;
	...
	setAttr ".tgi[1].ni[4].x" 828.5714111328125;
	setAttr ".tgi[1].ni[4].y" 428.57144165039062;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" -723.47149658203125;
	setAttr ".tgi[1].ni[5].y" 545.110107421875;
	setAttr ".tgi[1].ni[5].nvs" 18305;
	setAttr ".tgi[1].ni[6].x" -1582.93505859375;
	setAttr ".tgi[1].ni[6].y" 592.20416259765625;
	setAttr ".tgi[1].ni[6].nvs" 18305;
	setAttr ".tgi[1].ni[7].x" -76.528480529785156;
	setAttr ".tgi[1].ni[7].y" 238.41021728515625;
	setAttr ".tgi[1].ni[7].nvs" 18305;
	setAttr ".tgi[1].ni[8].x" 214.28572082519531;
	setAttr ".tgi[1].ni[8].y" 385.71429443359375;
	setAttr ".tgi[1].ni[8].nvs" 18304;
	setAttr ".tgi[1].ni[9].x" -407.68408203125;
	setAttr ".tgi[1].ni[9].y" 331.940673828125;
	setAttr ".tgi[1].ni[9].nvs" 18304;
	setAttr ".tgi[1].ni[10].x" -787.82562255859375;
	setAttr ".tgi[1].ni[10].y" 152.17434692382812;
	setAttr ".tgi[1].ni[10].nvs" 18305;
	setAttr ".tgi[1].ni[11].x" -423.05221557617188;
	setAttr ".tgi[1].ni[11].y" 172.11067199707031;
	setAttr ".tgi[1].ni[11].nvs" 18305;
	setAttr ".tgi[1].ni[12].x" 828.5714111328125;
	setAttr ".tgi[1].ni[12].y" 70;
	setAttr ".tgi[1].ni[12].nvs" 18304;
	setAttr ".tgi[1].ni[13].x" -1338.225341796875;
	setAttr ".tgi[1].ni[13].y" 401.08242797851562;
...
connectAttr "root_poser_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
...
connectAttr "output.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn";
...
connectAttr "outJointsSet.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn";
connectAttr "mirror_condition_2.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn"
		;
connectAttr "root_ctrJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[6].dn";
connectAttr "root_multMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[7].dn";
...
connectAttr "mirror_composeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[9].dn"
		;
connectAttr "mirror_condition.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[10].dn"
		;
connectAttr "outJoints.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[11].dn";
connectAttr "system.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[12].dn";
connectAttr "root_ctrJoint_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[13].dn"
		;
