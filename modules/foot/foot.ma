...
//Name: foot.ma
//Last modified: Fri, Sep 06, 2024 08:58:37 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "D1102BF5-46B0-193A-C9E2-2484927E81F0";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.5499687617510691 4.506289416552117 3.986031923206252 ;
	setAttr ".r" -type "double3" -29.400000000004251 54.400000000001064 2.7318580819824159e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 7.7291180625030673;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "101E2836-4C36-E650-3496-C0971A1C2829";
	setAttr -s 23 ".lnk";
	setAttr -s 23 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "0E0FB697-4363-AD60-39AF-10A9038F7474";
createNode displayLayer -n "defaultLayer";
	rename -uid "19CE01F8-4DF6-369B-03C9-E4ACC39F3E53";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "978BC37A-4DDE-1266-E46A-CFAD5F74368A";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "18C1BCA4-45F3-0B7D-89AD-7B9A8058511D";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C49C0C4C-446A-8C88-D355-DF96D202C32E";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "498FCF48-4930-6D78-E285-3C927D63E34B";
	setAttr -s 3 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -5207.7383140486072 -2007.1428926927717 ;
	setAttr ".tgi[0].vh" -type "double2" 8506.547706775289 1707.1429046137 ;
	...
	setAttr ".tgi[0].ni[4].x" 1295.7142333984375;
	...
	setAttr ".tgi[1].vl" -type "double2" -4461.9050103520594 -2810.1190512615403 ;
	setAttr ".tgi[1].vh" -type "double2" 9252.3810104718359 904.16674604493153 ;
	setAttr -s 7 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" 2262.857177734375;
	setAttr ".tgi[1].ni[0].y" -462.85714721679688;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" 2262.016845703125;
	setAttr ".tgi[1].ni[1].y" -666.55462646484375;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" 2314.28564453125;
	setAttr ".tgi[1].ni[2].y" -925.71429443359375;
	setAttr ".tgi[1].ni[2].nvs" 18304;
	setAttr ".tgi[1].ni[3].x" 2262.857177734375;
	setAttr ".tgi[1].ni[3].y" -361.42855834960938;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" 2262.857177734375;
	setAttr ".tgi[1].ni[4].y" -564.28570556640625;
	...
	setAttr ".tgi[2].vl" -type "double2" -807.41276568920944 -1384.8855855536312 ;
	setAttr ".tgi[2].vh" -type "double2" 229.20861091704654 -35.690507638539657 ;
	setAttr -s 4 ".tgi[2].ni";
	setAttr ".tgi[2].ni[0].x" -172.85714721679688;
	setAttr ".tgi[2].ni[0].y" -627.14288330078125;
	setAttr ".tgi[2].ni[0].nvs" 18304;
	setAttr ".tgi[2].ni[1].x" -480;
	setAttr ".tgi[2].ni[1].y" -497.14285278320312;
...
connectAttr "toe_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn";
...
connectAttr "toeTip_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[8].dn"
		;
connectAttr "ik_toe_upvShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[9].dn";
...
connectAttr "toe_poserOrient_aimConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn"
		;
connectAttr "mainPoser_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn"
		;
connectAttr "mainPoserShapeOrig.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn"
		;
connectAttr "toeTip_poserOrient_aimConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[3].dn"
		;
connectAttr "root_poserOrient_aimConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn"
		;
