...
//Name: foot2.ma
//Last modified: Thu, Aug 08, 2024 05:44:16 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "617550A0-4F2F-7CFF-FC03-C58080ACE6AB";
...
createNode locator -n "root_initLocShape" -p "root_initLoc";
	...
	setAttr -k off ".v";
createNode transform -n "foot_initLoc" -p "root_poser";
	rename -uid "303601D7-40F7-B8F3-D0A7-98BB11BDB955";
	setAttr ".ove" yes;
	setAttr ".ovc" 10;
	setAttr -k on ".t";
	setAttr -k on ".r";
createNode locator -n "foot_initLoc_locShape" -p "foot_initLoc";
...
createNode aimConstraint -n "toe_poserOrient_aimConstraint1" -p "toe_poserOrient";
	...
	setAttr -k on ".w0";
createNode transform -n "toeFk_initLoc" -p "toe_poserOrient";
...
createNode locator -n "toeFk_initLocShape" -p "toeFk_initLoc";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.3638243863277753 4.4422687641118159 3.654850920204848 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 7.4118564630946544;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "36F2F318-45DA-F138-FD83-1698B82BA931";
	setAttr -s 23 ".lnk";
	setAttr -s 23 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "2C0ECDE8-43AE-858D-1EDF-E2A8BE6DA10C";
createNode displayLayer -n "defaultLayer";
	rename -uid "19CE01F8-4DF6-369B-03C9-E4ACC39F3E53";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "FDD16EBF-4D42-812E-443D-2A9BA4A96AC1";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9A80C289-481B-E2AB-39A3-F3B5701E43BB";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "FCA7E711-434A-1D84-683F-E79202C227F5";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "B52B990F-4F9B-0848-B177-C294CCE99704";
	setAttr -s 3 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -5210.1192663349821 -2004.7619404064296 ;
	setAttr ".tgi[0].vh" -type "double2" 8504.1667544889151 1709.5238569000419 ;
	...
	setAttr ".tgi[0].ni[5].x" 1602.857177734375;
	...
	setAttr ".tgi[1].vl" -type "double2" 386.26372091499536 -1494.0475596794984 ;
	setAttr ".tgi[1].vh" -type "double2" 4399.4503746320988 -407.1428409644497 ;
	...
	setAttr ".tgi[1].ni[6].x" 2262.016845703125;
	setAttr ".tgi[1].ni[6].y" -666.55462646484375;
	setAttr ".tgi[1].ni[6].nvs" 18304;
	setAttr ".tgi[2].tn" -type "string" "Untitled_3";
	setAttr ".tgi[2].vl" -type "double2" -252.01464200049 -1885.7142107827356 ;
	setAttr ".tgi[2].vh" -type "double2" 3756.7764074956749 -799.99996821085745 ;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -k on ".fzn";
	setAttr -av -k on ".ihi";
...
connectAttr "mirror_condition.ocr" "foot_initLoc.sx";
...
connectAttr "toeTip_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[5].dn";
...
connectAttr "toeBall_toeTip_distance.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[9].dn"
		;
connectAttr "toe_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[10].dn"
		;
connectAttr "mirror_condition.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[11].dn"
		;
connectAttr "toeTip_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[12].dn"
		;
