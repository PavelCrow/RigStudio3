// pk_chainDynamics2 - то же, что pk_chainDynamics, но отдельным плагином:
// здесь пробуется коллизия, а рабочий pk_dynamics остаётся как есть. Когда
// проба сойдётся, это вернётся в основную ноду.
//
#pragma once
...
// segment.
class PkChainDyn2Node : public MPxNode
{
public:
    static void*   creator();
