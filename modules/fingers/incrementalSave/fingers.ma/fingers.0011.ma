...
//Name: fingers.ma
//Last modified: Tue, Jun 18, 2024 04:36:03 AM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "92DAC342-4C51-857C-DB79-ADB84FAB7F4B";
...
createNode transform -n "mainPoser" -p "posers";
	...
	setAttr ".ove" yes;
	setAttr ".ovc" 10;
	setAttr ".t" -type "double3" 0.52094591823157166 0.44321175844107441 -0.30913537923168377 ;
	setAttr -k on ".s";
	setAttr -k off ".sy";
	setAttr -k off ".sz";
	setAttr -k on ".size";
...
createNode nurbsCurve -n "thumbFinger_posers_curveShape" -p "thumbFinger_posers_curve";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		5 0 1 2 3 4
		5
		0.52094591823157166 0.44321175844107441 -0.30913537923168377
		0.80907152313132691 0.44321175844107441 0.17912704047562361
		1.025771688298704 0.44321175844107424 0.39582720564300178
		1.2333355918432547 0.44321175844107441 0.60339110918755301
		1.4454676261992185 0.44321175844107441 0.81552314354351774
		;
...
createNode nurbsCurve -n "indexFinger_posers_curveShape" -p "indexFinger_posers_curve";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		6
		0.52094591823157166 0.44321175844107441 -0.30913537923168377
		0.87760384288357063 0.44321175844107441 -0.044443665071739913
		1.2704632214115825 0.44321175844107441 0.015792214944872207
		1.5704632214115826 0.44321175844107441 0.015792214944872207
		1.8704632214115824 0.44321175844107441 0.015792214944872207
		2.1704632214115827 0.44321175844107441 0.015792214944872207
		;
...
createNode nurbsCurve -n "middleFinger_posers_curveShape" -p "middleFinger_posers_curve";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		6
		0.52094591823157166 0.44321175844107441 -0.30913537923168377
		0.87760384288357063 0.44321175844107441 -0.21009088144785237
		1.2672929314448202 0.44321175844107441 -0.17423767858704409
		1.5672929314448203 0.44321175844107441 -0.17423767858704409
		1.8672929314448203 0.44321175844107441 -0.17423767858704409
		2.1672929314448202 0.44321175844107441 -0.17423767858704409
		;
...
createNode nurbsCurve -n "ringFinger_posers_curveShape" -p "ringFinger_posers_curve";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		6
		0.52094591823157166 0.44321175844107441 -0.30913537923168377
		0.87760384288357063 0.44321175844107441 -0.35981048086472378
		1.2647555217674831 0.44321175844107441 -0.38150604335950222
		1.5647555217674831 0.44321175844107441 -0.38150604335950222
		1.8647555217674832 0.44321175844107441 -0.38150604335950222
		2.164755521767483 0.44321175844107441 -0.38150604335950222
		;
...
createNode nurbsCurve -n "pinkyFinger_posers_curveShape" -p "pinkyFinger_posers_curve";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		6
		0.52094591823157166 0.44321175844107441 -0.30913537923168377
		0.87760384288357063 0.44321175844107485 -0.51271560367344293
		1.2651152551083196 0.44321175844107441 -0.5884721901575718
		1.5651152551083196 0.44321175844107441 -0.5884721901575718
		1.8651152551083197 0.44321175844107441 -0.5884721901575718
		2.1651152551083195 0.44321175844107441 -0.5884721901575718
		;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.5166757903241797 2.3457112136912124 1.7285563822307655 ;
	setAttr ".r" -type "double3" -46.800000000122338 44.000000000000625 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".ncp" 0.001;
	setAttr ".fcp" 50000;
	setAttr ".coi" 2.8937053734627076;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "F6CCEA95-41BE-8CEF-778B-249913702120";
	setAttr -s 3 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -1428.189233293145 -904.1688424772293 ;
	setAttr ".tgi[0].vh" -type "double2" -303.13797221553062 141.40024372189919 ;
	...
	setAttr ".tgi[0].ni[3].x" -546.32611083984375;
	setAttr ".tgi[0].ni[3].y" -148.66389465332031;
	setAttr ".tgi[0].ni[3].nvs" 18305;
	setAttr ".tgi[0].ni[4].x" -260;
	setAttr ".tgi[0].ni[4].y" -315.71429443359375;
	setAttr ".tgi[0].ni[4].nvs" 18304;
	setAttr ".tgi[0].ni[5].x" 35.714286804199219;
	setAttr ".tgi[0].ni[5].y" -631.4285888671875;
	...
	setAttr ".tgi[0].ni[10].x" -911.4285888671875;
	...
	setAttr ".tgi[0].ni[12].y" -901.4285888671875;
	setAttr ".tgi[0].ni[12].nvs" 18304;
	setAttr ".tgi[0].ni[13].x" -1281.4285888671875;
	setAttr ".tgi[0].ni[13].y" -597.14288330078125;
	setAttr ".tgi[0].ni[13].nvs" 18304;
	setAttr ".tgi[0].ni[14].x" -911.4285888671875;
	setAttr ".tgi[0].ni[14].y" -625.71429443359375;
	setAttr ".tgi[0].ni[14].nvs" 18304;
	setAttr ".tgi[0].ni[15].x" -911.4285888671875;
	setAttr ".tgi[0].ni[15].y" -142.87564086914062;
	setAttr ".tgi[0].ni[15].nvs" 18305;
	setAttr ".tgi[0].ni[16].x" -911.4285888671875;
	setAttr ".tgi[0].ni[16].y" -727.14288330078125;
	...
	setAttr ".tgi[0].ni[20].y" -1611.4285888671875;
	setAttr ".tgi[0].ni[20].nvs" 18304;
	setAttr ".tgi[0].ni[21].x" -1281.4285888671875;
	setAttr ".tgi[0].ni[21].y" -698.5714111328125;
	setAttr ".tgi[0].ni[21].nvs" 18304;
	setAttr ".tgi[0].ni[22].x" -1281.4285888671875;
	setAttr ".tgi[0].ni[22].y" -1510;
	setAttr ".tgi[0].ni[22].nvs" 18304;
	setAttr ".tgi[0].ni[23].x" -1281.4285888671875;
	setAttr ".tgi[0].ni[23].y" 575.71429443359375;
	setAttr ".tgi[0].ni[23].nvs" 18304;
	setAttr ".tgi[0].ni[24].x" -1281.4285888671875;
	setAttr ".tgi[0].ni[24].y" -292.85714721679688;
	setAttr ".tgi[0].ni[24].nvs" 18304;
	setAttr ".tgi[0].ni[25].x" -1281.4285888671875;
	setAttr ".tgi[0].ni[25].y" 474.28570556640625;
	setAttr ".tgi[0].ni[25].nvs" 18304;
	setAttr ".tgi[0].ni[26].x" -1281.4285888671875;
	setAttr ".tgi[0].ni[26].y" -800;
	setAttr ".tgi[0].ni[26].nvs" 18304;
	setAttr ".tgi[0].ni[27].x" -1281.4285888671875;
	setAttr ".tgi[0].ni[27].y" 880;
	setAttr ".tgi[0].ni[27].nvs" 18304;
	setAttr ".tgi[0].ni[28].x" -1281.4285888671875;
	setAttr ".tgi[0].ni[28].y" -1205.7142333984375;
	setAttr ".tgi[0].ni[28].nvs" 18304;
	setAttr ".tgi[0].ni[29].x" -1281.4285888671875;
	setAttr ".tgi[0].ni[29].y" -1002.8571166992188;
	setAttr ".tgi[0].ni[29].nvs" 18304;
	setAttr ".tgi[0].ni[30].x" -1642.5057373046875;
	setAttr ".tgi[0].ni[30].y" -127.71768188476562;
	...
	setAttr ".tgi[0].ni[32].y" 372.85714721679688;
	setAttr ".tgi[0].ni[32].nvs" 18304;
	setAttr ".tgi[0].ni[33].x" -1281.4285888671875;
	setAttr ".tgi[0].ni[33].y" -1408.5714111328125;
	setAttr ".tgi[0].ni[33].nvs" 18304;
	setAttr ".tgi[0].ni[34].x" -1281.4285888671875;
	setAttr ".tgi[0].ni[34].y" -191.42857360839844;
	setAttr ".tgi[0].ni[34].nvs" 18304;
	setAttr ".tgi[0].ni[35].x" -911.4285888671875;
	...
	setAttr ".tgi[0].ni[37].y" 677.14288330078125;
	setAttr ".tgi[0].ni[37].nvs" 18304;
	setAttr ".tgi[0].ni[38].x" -1281.4285888671875;
	setAttr ".tgi[0].ni[38].y" -1307.142822265625;
	setAttr ".tgi[0].ni[38].nvs" 18304;
	setAttr ".tgi[0].ni[39].x" -1281.4285888671875;
	setAttr ".tgi[0].ni
	setAttr ".tgi[2].ni[10].y" -2807.142822265625;
	setAttr ".tgi[2].ni[10].nvs" 18304;
	setAttr ".tgi[2].ni[11].x" 2980;
	setAttr ".tgi[2].ni[11].y" -2998.571533203125;
	setAttr ".tgi[2].ni[11].nvs" 18304;
	setAttr ".tgi[2].ni[12].x" 1660;
	setAttr ".tgi[2].ni[12].y" -2981.428466796875;
	setAttr ".tgi[2].ni[12].nvs" 18304;
	setAttr ".tgi[2].ni[13].x" 1985.7142333984375;
	setAttr ".tgi[2].ni[13].y" -2908.571533203125;
	setAttr ".tgi[2].ni[13].nvs" 18305;
	setAttr ".tgi[2].ni[14].x" 1660;
	setAttr ".tgi[2].ni[14].y" -3227.142822265625;
...
connectAttr "middleFinger_posers_sweepShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "indexFinger_posers_sweepShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
connectAttr "thumbFinger_posers_sweepShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "sweepMeshCreator2.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "pinkyFinger_posers_sweepShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "indexFinger_posers_sweep.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "thumbFinger_posers_sweep.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[6].dn"
		;
connectAttr "ringFinger_posers_sweep.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[7].dn"
		;
connectAttr "ringFinger_posers_sweepShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[8].dn"
		;
connectAttr "middleFinger_posers_sweep.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[9].dn"
		;
connectAttr "indexFinger_posers_curveShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[10].dn"
		;
connectAttr "thumbFingerB_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[11].dn"
		;
connectAttr "middleFingerD_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[12].dn"
		;
connectAttr "pinkyFingerRoot_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[13].dn"
		;
connectAttr "middleFinger_posers_curveShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[14].dn"
		;
connectAttr "multDoubleLinear26.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[15].dn"
		;
connectAttr "ringFinger_posers_curveShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[16].dn"
		;
connectAttr "mainPoser_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[17].dn"
		;
connectAttr "pinkyFingerB_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[18].dn"
		;
connectAttr "indexFingerRoot_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[19].dn"
		;
connectAttr "ringFingerC_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[20].dn"
		;
connectAttr "pinkyFingerD_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[21].dn"
		;
connectAttr "ringFingerB_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[22].dn"
		;
connectAttr "thumbFingerD_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[23].dn"
		;
connectAttr "pinkyFingerC_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[24].dn"
		;
connectAttr "indexFingerD_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[25].dn"
		;
connectAttr "middleFingerB_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[26].dn"
		;
connectAttr "thumbFingerC_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[27].dn"
		;
connectAttr "middleFingerC_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[28].dn"
		;
connectAttr "middleFingerRoot_poserOrientShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[29].dn"
		;
connectAttr "mainPoser.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[30].dn";
connectAttr "ringFingerA_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[31].dn"
		;
connectAttr "indexFingerA_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[32].dn"
		;
connectAttr "ringFingerD_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[33].dn"
		;
connectAttr "root_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[34].dn"
		;
connectAttr "thumbFinger_posers_curveShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[35].dn"
		;
connectAttr "pinkyFingerA_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[36].dn"
		;
connectAttr "thumbFingerA_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[37].dn"
		;
connectAttr "ringFingerRoot_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[38].dn"
		;
connectAttr "indexFingerC_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[39].dn"
		;
connectAttr "pinkyFinger_posers_curveShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[40].dn"
		;
connectAttr "indexFingerB_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[41].dn"
		;
connectAttr "middleFingerA_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[42].dn"
		;
connectAttr "pinkyFinger_posers_sweep.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[43].dn"
		;
...
connectAttr "indexFingerC_poser.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[74].dn"
		;
connectAttr "thumbFinger_1.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[0].dn";
connectAttr "thumbFinger_1_outJoint_multMat.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[1].dn"
		;
connectAttr "multDoubleLinear17.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[2].dn"
		;
connectAttr "thumbFinger_1_outJoint_decMat.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[3].dn"
		;
connectAttr "fingers.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[4].dn";
connectAttr "mod.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[5].dn";
connectAttr "thumbFinger_1_group_2.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[6].dn"
		;
connectAttr "multDoubleLinear2.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[7].dn"
		;
connectAttr "unitConversion1426.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[8].dn"
		;
...
connectAttr "mirror_condition.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[10].dn"
		;
connectAttr "thumbFinger_1_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[11].dn"
		;
connectAttr "thumbFinger_1_group_decMat.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[12].dn"
		;
connectAttr "thumbFinger_1_group.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[13].dn"
		;
connectAttr "unitConversion1441.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[14].dn"
		;
