...
//Name: point.ma
//Last modified: Wed, Jan 10, 2024 07:05:57 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "BD3CF2C5-4EA6-9822-ECDF-EFBCBEBCB5DA";
...
createNode transform -n "posers_bifrostGraph" -p "system";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.302950343096958 9.2168652763204122 11.21851228286387 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 15.103543741269714;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "DE5793A7-43D3-0BFC-05F0-EA961A646D95";
	setAttr -s 8 ".lnk";
	setAttr -s 8 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "17FB435B-4895-16CC-6299-6FB5A9E2D081";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E3654D23-449C-75CB-0043-C38D94DDD51E";
...
createNode surfaceShader -n "blue_rsMat";
	rename -uid "AB4ACC42-4DE5-AA32-F6F5-06A339F289AB";
	addAttr -ci true -sn "moduleName" -ln "moduleName" -dt "string";
	addAttr -ci true -sn "moduleType" -ln "moduleType" -dt "string";
...
createNode surfaceShader -n "green_rsMat";
	rename -uid "D02AC8B8-4543-77DE-8E14-18AD793B3834";
	addAttr -ci true -sn "moduleName" -ln "moduleName" -dt "string";
	addAttr -ci true -sn "moduleType" -ln "moduleType" -dt "string";
...
createNode shadingEngine -n "green_rsSG";
	rename -uid "5F975C87-4837-2339-8369-5E8506096D57";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo6";
	rename -uid "15F44837-4E24-4648-4C01-61AD4DDA53AB";
createNode shadingEngine -n "blue_rsSG";
	rename -uid "80D6E8B0-4371-7484-E0B8-8C81C8F9A433";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo7";
	rename -uid "68B32E49-4507-13CA-34F4-69B337DD5722";
createNode surfaceShader -n "red_rsMat";
	rename -uid "D0F717A5-4535-96A8-0F83-998EA376090F";
	addAttr -ci true -sn "moduleName" -ln "moduleName" -dt "string";
	addAttr -ci true -sn "moduleType" -ln "moduleType" -dt "string";
...
createNode shadingEngine -n "red_rsSG";
	rename -uid "026A6CD7-4969-6CDF-FDFE-49B5857A78ED";
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo8";
	rename -uid "514D8518-4FF8-4A4E-A526-388F46759977";
createNode shadingEngine -n "root_red_rsSG";
	rename -uid "8EE611E1-456A-A222-A4C8-C3BEDDE7C85D";
	addAttr -ci true -sn "moduleName" -ln "moduleName" -dt "string";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
	setAttr -l on ".moduleName" -type "string" "root";
createNode materialInfo -n "root_materialInfo1";
	rename -uid "9E6765E0-499C-3178-DE54-7F98AC545B32";
	addAttr -ci true -sn "moduleName" -ln "moduleName" -dt "string";
	setAttr -l on ".moduleName" -type "string" "root";
createNode shadingEngine -n "root_green_rsSG";
	rename -uid "420EA86D-4F10-EDC4-F1A0-D1B27EA5CF81";
	addAttr -ci true -sn "moduleName" -ln "moduleName" -dt "string";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
	setAttr -l on ".moduleName" -type "string" "root";
createNode materialInfo -n "root_materialInfo2";
	rename -uid "E8079C82-4DEE-2C80-73CA-36B0747896C3";
	addAttr -ci true -sn "moduleName" -ln "moduleName" -dt "string";
	setAttr -l on ".moduleName" -type "string" "root";
createNode shadingEngine -n "root_blue_rsSG";
	rename -uid "97C48138-494F-39C6-CF4A-2AAD9A8C8452";
	addAttr -ci true -sn "moduleName" -ln "moduleName" -dt "string";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
	setAttr -l on ".moduleName" -type "string" "root";
createNode materialInfo -n "root_materialInfo3";
	rename -uid "D9B6ABD7-41FD-7FCD-90E6-2282A3402585";
	addAttr -ci true -sn "moduleName" -ln "moduleName" -dt "string";
	setAttr -l on ".moduleName" -type "string" "root";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "65166B46-4A48-49D7-275E-AAB5CF43690C";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E73FBA4B-44D6-4FB8-1351-F4A3370705D7";
createNode decomposeMatrix -n "root_poser_decomposeMatrix";
	rename -uid "BA1C7B19-435C-8DDD-2F57-B38B20EB0DB8";
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "7B38224D-44BF-FC42-ED17-808F429760E2";
	setAttr -s 2 ".tgi";
...
connectAttr "root_ctrJoint.iog" "outJointsSet.dsm" -na;
...
connectAttr "green_rsSG.msg" "materialInfo6.sg";
connectAttr "green_rsMat.msg" "materialInfo6.m";
connectAttr "green_rsMat.msg" "materialInfo6.t" -na;
connectAttr "blue_rsMat.oc" "blue_rsSG.ss";
connectAttr "blue_rsSG.msg" "materialInfo7.sg";
connectAttr "blue_rsMat.msg" "materialInfo7.m";
connectAttr "blue_rsMat.msg" "materialInfo7.t" -na;
connectAttr "red_rsMat.oc" "red_rsSG.ss";
connectAttr "red_rsSG.msg" "materialInfo8.sg";
connectAttr "red_rsMat.msg" "materialInfo8.m";
connectAttr "red_rsMat.msg" "materialInfo8.t" -na;
