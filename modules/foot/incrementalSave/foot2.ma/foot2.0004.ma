...
//Name: foot2.ma
//Last modified: Fri, Jun 14, 2024 07:33:31 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "3B101BC0-425D-BCAD-2DDE-AAB4AEDC23F6";
...
createNode nurbsCurve -n "posers_curveShape" -p "posers_curve";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		3 0 1 2
		3
		-4.4408920985006262e-16 0.93034297947780797 -1.2206470468465951
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.3796681367765178 5.6872160805332488 5.3285191951947581 ;
	setAttr ".r" -type "double3" -31.800000000004236 49.199999999997679 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 10.056514083124684;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "5C006629-4FE9-370D-096F-33AF2B43CC31";
	setAttr -s 3 ".tgi";
	...
	setAttr ".tgi[1].vl" -type "double2" 1891.5787014599352 -1413.120814599934 ;
	setAttr ".tgi[1].vh" -type "double2" 2889.8980011889271 -484.54941207423161 ;
	setAttr -s 7 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" 2262.857177734375;
	setAttr ".tgi[1].ni[0].y" -361.42855834960938;
	...
	setAttr ".tgi[1].ni[3].x" 2262.016845703125;
	setAttr ".tgi[1].ni[3].y" -666.55462646484375;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" 2314.28564453125;
	setAttr ".tgi[1].ni[4].y" -925.71429443359375;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" 2314.28564453125;
	setAttr ".tgi[1].ni[5].y" -795.71429443359375;
	...
	setAttr ".tgi[2].vl" -type "double2" 854.74789925035884 -2001.5101120508707 ;
	setAttr ".tgi[2].vh" -type "double2" 2360.3057463570403 -601.13854550803967 ;
	setAttr -s 21 ".tgi[2].ni";
	setAttr ".tgi[2].ni[0].x" 1850;
	setAttr ".tgi[2].ni[0].y" -147.14285278320312;
	setAttr ".tgi[2].ni[0].nvs" 18304;
	setAttr ".tgi[2].ni[1].x" 1850;
	setAttr ".tgi[2].ni[1].y" -608.5714111328125;
	setAttr ".tgi[2].ni[1].nvs" 18304;
	setAttr ".tgi[2].ni[2].x" 1850;
	setAttr ".tgi[2].ni[2].y" -324.28570556640625;
	setAttr ".tgi[2].ni[2].nvs" 18304;
	setAttr ".tgi[2].ni[3].x" 1235.7142333984375;
	setAttr ".tgi[2].ni[3].y" -151.42857360839844;
	setAttr ".tgi[2].ni[3].nvs" 18305;
	setAttr ".tgi[2].ni[4].x" 1850;
	setAttr ".tgi[2].ni[4].y" -954.28570556640625;
	setAttr ".tgi[2].ni[4].nvs" 18304;
	setAttr ".tgi[2].ni[5].x" 1083.877197265625;
	setAttr ".tgi[2].ni[5].y" -744.4013671875;
	setAttr ".tgi[2].ni[5].nvs" 18305;
	setAttr ".tgi[2].ni[6].x" 1560.599365234375;
	setAttr ".tgi[2].ni[6].y" -926.15240478515625;
	setAttr ".tgi[2].ni[6].nvs" 18305;
	setAttr ".tgi[2].ni[7].x" 621.4285888671875;
	setAttr ".tgi[2].ni[7].y" -510;
	setAttr ".tgi[2].ni[7].nvs" 18304;
	setAttr ".tgi[2].ni[8].x" 928.5714111328125;
	setAttr ".tgi[2].ni[8].y" -262.85714721679688;
	setAttr ".tgi[2].ni[8].nvs" 18304;
	setAttr ".tgi[2].ni[9].x" 928.5714111328125;
	setAttr ".tgi[2].ni[9].y" -447.14285278320312;
	setAttr ".tgi[2].ni[9].nvs" 18304;
	setAttr ".tgi[2].ni[10].x" 1788.572021484375;
	setAttr ".tgi[2].ni[10].y" -302.5316162109375;
	setAttr ".tgi[2].ni[10].nvs" 18304;
	setAttr ".tgi[2].ni[11].x" 1948.5714111328125;
	setAttr ".tgi[2].ni[11].y" -231.42857360839844;
	setAttr ".tgi[2].ni[11].nvs" 18304;
	setAttr ".tgi[2].ni[12].x" 1930.2838134765625;
	setAttr ".tgi[2].ni[12].y" -201.52949523925781;
	setAttr ".tgi[2].ni[12].nvs" 18304;
	setAttr ".tgi[2].ni[13].x" 600.6514892578125;
	setAttr ".tgi[2].ni[13].y" -640.71856689453125;
	setAttr ".tgi[2].ni[13].nvs" 18305;
	setAttr ".tgi[2].ni[14].x" 1850;
	setAttr ".tgi[2].ni[14].y" -710;
	setAttr ".tgi[2].ni[14].nvs" 18305;
	setAttr ".tgi[2].ni[15].x" 1542.857177734375;
	setAttr ".tgi[2].ni[15].y" -684.28570556640625;
	setAttr ".tgi[2].ni[15].nvs" 18305;
	setAttr ".tgi[2].ni[16].x" 1542.857177734375;
	setAttr ".tgi[2].ni[16].y" -95.714286804199219;
	setAttr ".tgi[2].ni[16].nvs" 18305;
	setAttr ".tgi[2].ni[17].x" 1542.857177734375;
	setAttr ".tgi[2].ni[17].y" -272.85714721679688;
	setAttr ".tgi[2].ni[17].nvs" 18305;
	setAttr ".tgi[2].ni[18].x" 1542.857177734375;
	setAttr ".tgi[2].ni[18].y" -507.14285278320312;
	setAttr ".tgi[2].ni[18].nvs" 18305;
	setAttr ".tgi[2].ni[19].x" 889.64080810546875;
	setAttr ".tgi[2].ni[19].y" -942.97613525390625;
	setAttr ".tgi[2].ni[19].nvs" 18305;
	setAttr ".tgi[2].ni[20].x" 1288.78857421875;
	setAttr ".tgi[2].ni[20].y" -995.05645751953125;
...
connectAttr "mainPoser_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[12].dn"
		;
connectAttr "toeTip_poserOrient_aimConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn"
		;
...
connectAttr "root_poserOrient_aimConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn"
		;
connectAttr "mainPoser_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[3].dn"
		;
connectAttr "mainPoserShapeOrig.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn"
		;
connectAttr "mainPoserShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn";
...
connectAttr "posers_sweepShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[4].dn"
		;
connectAttr "multDoubleLinear1628.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[5].dn"
		;
connectAttr "sweepMeshCreator1.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[6].dn"
		;
connectAttr "toe_poser.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[7].dn";
connectAttr "root_poser.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[8].dn";
connectAttr "toeTip_poser.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[9].dn";
connectAttr "mainPoser_clusterHandleShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[10].dn"
		;
connectAttr "mainPoserShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[11].dn";
connectAttr "mainPoserShapeOrig.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[12].dn"
		;
connectAttr "mainPoser.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[13].dn";
connectAttr "mainPoser_clusterHandle.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[14].dn"
		;
connectAttr "multDoubleLinear1627.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[15].dn"
		;
connectAttr "makeNurbSphere1.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[16].dn"
		;
connectAttr "makeNurbSphere2.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[17].dn"
		;
connectAttr "makeNurbSphere3.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[18].dn"
		;
connectAttr "mainPoser_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[19].dn"
		;
connectAttr "multiplyDivide6.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[20].dn"
		;
