...
//Name: point.ma
//Last modified: Sun, May 12, 2024 07:31:56 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "28194AC6-4B7E-7937-5601-B4BAA7079ABA";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.675720582261867 9.5329743334489692 15.151967178524355 ;
	setAttr ".r" -type "double3" -25.799999999665552 -322.80000000002076 -1.9965067284302733e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 21.576835312693763;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "AFDE67A9-4335-67AF-5441-F398E7371FE5";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "E0A33D04-404D-90E3-4FB9-6F93D7722DC0";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "CED9CF57-4224-8AB5-96D4-FEA13D467DC1";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "E587E61E-4828-FB8C-21B2-BDA77653A3B6";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "A9B4564E-45DB-7C4F-07C2-ACAB5E47F842";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "7EBE1A15-4FED-BAAB-EE75-DA9C67EFCD20";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 1060.0247295883883 112.78994106663473 ;
	setAttr ".tgi[0].vh" -type "double2" 2096.1591543071131 1392.0397056634961 ;
	setAttr -s 2 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 1481.4285888671875;
	setAttr ".tgi[0].ni[0].y" 778.5714111328125;
	setAttr ".tgi[0].ni[0].nvs" 18304;
	setAttr ".tgi[0].ni[1].x" 1788.5714111328125;
	setAttr ".tgi[0].ni[1].y" 778.5714111328125;
	setAttr ".tgi[0].ni[1].nvs" 18304;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -1702.2209081789981 -1630.7248818058004 ;
	setAttr ".tgi[1].vh" -type "double2" -525.33474749593393 -177.6978342585538 ;
	setAttr -s 13 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -868.0225830078125;
	setAttr ".tgi[1].ni[0].y" -1358.52880859375;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" -585.82275390625;
	setAttr ".tgi[1].ni[1].y" -1230.97802734375;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" -1234.1221923828125;
	setAttr ".tgi[1].ni[2].y" -987.71124267578125;
	setAttr ".tgi[1].ni[2].nvs" 18305;
	setAttr ".tgi[1].ni[3].x" -345.71429443359375;
	setAttr ".tgi[1].ni[3].y" -602.85711669921875;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" -1549.3231201171875;
	setAttr ".tgi[1].ni[4].y" -961.98040771484375;
	setAttr ".tgi[1].ni[4].nvs" 18305;
	setAttr ".tgi[1].ni[5].x" -1574.2857666015625;
	setAttr ".tgi[1].ni[5].y" -595.71429443359375;
	setAttr ".tgi[1].ni[5].nvs" 18304;
	setAttr ".tgi[1].ni[6].x" -1905.7142333984375;
	setAttr ".tgi[1].ni[6].y" -660;
	setAttr ".tgi[1].ni[6].nvs" 18304;
	setAttr ".tgi[1].ni[7].x" -2212.857177734375;
	setAttr ".tgi[1].ni[7].y" -631.4285888671875;
	setAttr ".tgi[1].ni[7].nvs" 18304;
	setAttr ".tgi[1].ni[8].x" -1574.2857666015625;
	setAttr ".tgi[1].ni[8].y" -754.28570556640625;
	setAttr ".tgi[1].ni[8].nvs" 18304;
	setAttr ".tgi[1].ni[9].x" -931.46600341796875;
	setAttr ".tgi[1].ni[9].y" -885.7333984375;
	setAttr ".tgi[1].ni[9].nvs" 18305;
	setAttr ".tgi[1].ni[10].x" -371.17239379882812;
	setAttr ".tgi[1].ni[10].y" -954.12451171875;
	setAttr ".tgi[1].ni[10].nvs" 18305;
	setAttr ".tgi[1].ni[11].x" -931.82745361328125;
	setAttr ".tgi[1].ni[11].y" -485.27206420898438;
	setAttr ".tgi[1].ni[11].nvs" 18304;
	setAttr ".tgi[1].ni[12].x" -652.85711669921875;
	setAttr ".tgi[1].ni[12].y" -602.85711669921875;
...
connectAttr "mute_mod_scaleX.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn";
...
connectAttr "root_initLocShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn"
		;
connectAttr "mute_mod_scaleX.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn";
...
connectAttr "mirror_condition.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn"
		;
connectAttr "mod.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn";
connectAttr "root_ctrJoint_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[6].dn"
		;
connectAttr "root_ctrJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[7].dn";
connectAttr "negate.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[8].dn";
