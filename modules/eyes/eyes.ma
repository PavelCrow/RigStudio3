...
//Name: eyes.ma
//Last modified: Mon, Nov 18, 2024 05:59:32 AM
//Codeset: 1251
file -lcu 1;
requires maya "2022";
...
fileInfo "UUID" "071FF4C6-4D0F-E23A-6EAC-EDBA3F9E5B47";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.1149657807575917 3.3814388229426422 7.5212208171578965 ;
	setAttr ".r" -type "double3" -25.800000000019786 26.799999999991385 -8.908260179897387e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".ncp" 0.001;
	setAttr ".fcp" 50000;
	setAttr ".coi" 8.5746359399838745;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "09871528-4583-BEF9-DBE5-F2AED8548C75";
	setAttr -s 6 ".lnk";
	setAttr -s 6 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "6047F3D6-4548-CEB2-3C2D-D8AC5F04FFDF";
createNode displayLayer -n "defaultLayer";
	rename -uid "F357F502-4252-ED91-F13A-ECA2301BB85F";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F167C3CF-448C-0C52-14D2-78B94725DE28";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "68D10EA3-4428-34CA-8415-088046D33360";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "83917171-465F-50CE-E317-7AA436D36677";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "C49D0EBA-4371-2E59-8557-8ABB04FBA4DE";
	setAttr -s 5 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -3438.0951014776133 -2642.6195594378228 ;
	setAttr ".tgi[0].vh" -type "double2" 636.90473659644147 2023.571964988945 ;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" 635.71426045327053 -103.09646765263601 ;
	setAttr ".tgi[1].vh" -type "double2" 1663.0951720097737 1073.3345243369349 ;
	setAttr -s 11 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" 985.71429443359375;
	setAttr ".tgi[1].ni[0].y" 324.28570556640625;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" 1311.4285888671875;
	setAttr ".tgi[1].ni[1].y" 228.57142639160156;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" 1311.4285888671875;
	setAttr ".tgi[1].ni[2].y" 532.85711669921875;
	...
	setAttr ".tgi[1].ni[4].y" 634.28570556640625;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" 596.98504638671875;
	setAttr ".tgi[1].ni[5].y" 316.47842407226562;
	setAttr ".tgi[1].ni[5].nvs" 18305;
	setAttr ".tgi[1].ni[6].x" 1311.4285888671875;
	setAttr ".tgi[1].ni[6].y" 330;
	setAttr ".tgi[1].ni[6].nvs" 18304;
	setAttr ".tgi[1].ni[7].x" 1311.4285888671875;
	setAttr ".tgi[1].ni[7].y" 735.71429443359375;
	setAttr ".tgi[1].ni[7].nvs" 18304;
	setAttr ".tgi[1].ni[8].x" 1311.4285888671875;
	setAttr ".tgi[1].ni[8].y" 431.42855834960938;
	setAttr ".tgi[1].ni[8].nvs" 18304;
	setAttr ".tgi[1].ni[9].x" 985.71429443359375;
	setAttr ".tgi[1].ni[9].y" 482.85714721679688;
	setAttr ".tgi[1].ni[9].nvs" 18304;
	setAttr ".tgi[1].ni[10].x" 1311.4285888671875;
	setAttr ".tgi[1].ni[10].y" 25.714284896850586;
	setAttr ".tgi[1].ni[10].nvs" 18304;
	setAttr ".tgi[2].tn" -type "string" "Untitled_3";
	setAttr ".tgi[2].vl" -type "double2" -1036.90472070187 -1208.5183334236388 ;
	setAttr ".tgi[2].vh" -type "double2" -180.95237376197963 -228.38637138366033 ;
	...
	setAttr ".tgi[3].vl" -type "double2" -1491.666607393161 -2468.6620040507432 ;
	setAttr ".tgi[3].vh" -type "double2" 4058.3331720696619 3886.5190905673076 ;
	setAttr ".tgi[4].tn" -type "string" "Untitled_5";
	setAttr ".tgi[4].vl" -type "double2" 22407.619143258962 4926.299345915947 ;
	setAttr ".tgi[4].vh" -type "double2" 23218.543490261047 5854.8707484416491 ;
	setAttr -s 10 ".tgi[4].ni";
	setAttr ".tgi[4].ni[0].x" 23330;
	setAttr ".tgi[4].ni[0].y" 5552.85693359375;
	setAttr ".tgi[4].ni[0].nvs" 18304;
	setAttr ".tgi[4].ni[1].x" 23330;
	setAttr ".tgi[4].ni[1].y" 5248.5712890625;
	setAttr ".tgi[4].ni[1].nvs" 18304;
	setAttr ".tgi[4].ni[2].x" 23330;
	setAttr ".tgi[4].ni[2].y" 5451.4287109375;
	setAttr ".tgi[4].ni[2].nvs" 18304;
	setAttr ".tgi[4].ni[3].x" 23637.142578125;
	setAttr ".tgi[4].ni[3].y" 5550;
	setAttr ".tgi[4].ni[3].nvs" 18304;
	setAttr ".tgi[4].ni[4].x" 23022.857421875;
	setAttr ".tgi[4].ni[4].y" 5388.5712890625;
	setAttr ".tgi[4].ni[4].nvs" 18304;
	setAttr ".tgi[4].ni[5].x" 23637.142578125;
	setAttr ".tgi[4].ni[5].y" 5448.5712890625;
	setAttr ".tgi[4].ni[5].nvs" 18304;
	setAttr ".tgi[4].ni[6].x" 22715.71484375;
	setAttr ".tgi[4].ni[6].y" 5417.14306640625;
	setAttr ".tgi[4].ni[6].nvs" 18305;
	setAttr ".tgi[4].ni[7].x" 23637.142578125;
	setAttr ".tgi[4].ni[7].y" 5347.14306640625;
	setAttr ".tgi[4].ni[7].nvs" 18304;
	setAttr ".tgi[4].ni[8].x" 23330;
	setAttr ".tgi[4].ni[8].y" 5350;
	setAttr ".tgi[4].ni[8].nvs" 18304;
	setAttr ".tgi[4].ni[9].x" 23637.142578125;
	setAttr ".tgi[4].ni[9].y" 5245.71435546875;
...
connectAttr "pos_reverse_multDoubleLinear.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn"
		;
connectAttr "r_ball_group.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn";
connectAttr "r_look_ik_group.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn";
connectAttr "l_look_ik_group.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[3].dn";
connectAttr "l_look_fk_group.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn";
connectAttr "end_poser.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn";
connectAttr "l_ball_group.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[6].dn";
connectAttr "r_look_fk_group.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[7].dn";
connectAttr "decomposeMatrix79.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[8].dn"
		;
connectAttr "multMatrix26.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[9].dn";
connectAttr "r_ball_controlInitLoc.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[10].dn"
		;
...
connectAttr "makeNurbSphere19.msg" "MayaNodeEditorSavedTabsInfo.tgi[4].ni[0].dn"
		;
connectAttr "makeNurbSphere21.msg" "MayaNodeEditorSavedTabsInfo.tgi[4].ni[1].dn"
		;
connectAttr "decomposeMatrix75.msg" "MayaNodeEditorSavedTabsInfo.tgi[4].ni[2].dn"
		;
connectAttr "end_poserNurbsShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[4].ni[3].dn"
		;
connectAttr "multiplyDivide12.msg" "MayaNodeEditorSavedTabsInfo.tgi[4].ni[4].dn"
		;
connectAttr "input.msg" "MayaNodeEditorSavedTabsInfo.tgi[4].ni[5].dn";
connectAttr "root_poser.msg" "MayaNodeEditorSavedTabsInfo.tgi[4].ni[6].dn";
connectAttr "root_poserNurbsShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[4].ni[7].dn"
		;
connectAttr "makeNurbSphere18.msg" "MayaNodeEditorSavedTabsInfo.tgi[4].ni[8].dn"
		;
connectAttr "length_poserNurbsShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[4].ni[9].dn"
		;
