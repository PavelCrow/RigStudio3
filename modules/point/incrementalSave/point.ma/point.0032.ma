...
//Name: point.ma
//Last modified: Fri, Jun 21, 2024 07:48:52 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "C4EC78FD-45C3-C866-2A98-38B1056F6B7E";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.4116417973576647 4.8166221692898814 10.778375430281731 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 12.543096277830685;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "AACF3486-4C88-3ABC-E9E4-61BF362F20BD";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "D49A71B5-4094-F097-8300-DE9E35D8667D";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "BC8ECE30-421B-AB05-3364-D399935814E8";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A1A53C3E-4382-B49A-FF30-52817CA448B8";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "EF4C4287-4BD6-8797-8CAD-1AB54AF1653B";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "7DD1817A-4C76-FAD1-54CB-B4BEC4A66DF2";
	setAttr -s 3 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 1272.8414244034291 -155.92438248895405 ;
	setAttr ".tgi[0].vh" -type "double2" 2529.5255892112536 1208.1581343211108 ;
	setAttr -s 12 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 2545.71435546875;
	setAttr ".tgi[0].ni[0].y" 930;
	setAttr ".tgi[0].ni[0].nvs" 18304;
	setAttr ".tgi[0].ni[1].x" 2238.571533203125;
	setAttr ".tgi[0].ni[1].y" 930;
	setAttr ".tgi[0].ni[1].nvs" 18304;
	setAttr ".tgi[0].ni[2].x" 1624.2857666015625;
	setAttr ".tgi[0].ni[2].y" 611.4285888671875;
	setAttr ".tgi[0].ni[2].nvs" 18304;
	setAttr ".tgi[0].ni[3].x" 2852.857177734375;
	setAttr ".tgi[0].ni[3].y" 1025.7142333984375;
	setAttr ".tgi[0].ni[3].nvs" 18305;
	setAttr ".tgi[0].ni[4].x" 1292.857177734375;
	setAttr ".tgi[0].ni[4].y" 570;
	setAttr ".tgi[0].ni[4].nvs" 18304;
	setAttr ".tgi[0].ni[5].x" 1949.945556640625;
	setAttr ".tgi[0].ni[5].y" 897.53106689453125;
	setAttr ".tgi[0].ni[5].nvs" 18305;
	setAttr ".tgi[0].ni[6].x" 1621.8167724609375;
	setAttr ".tgi[0].ni[6].y" 763.82769775390625;
	...
	setAttr ".tgi[0].ni[9].x" 3160;
	setAttr ".tgi[0].ni[9].y" 974.28570556640625;
	setAttr ".tgi[0].ni[9].nvs" 18304;
	setAttr ".tgi[0].ni[10].x" 3467.142822265625;
	setAttr ".tgi[0].ni[10].y" 554.28570556640625;
	setAttr ".tgi[0].ni[10].nvs" 18305;
	setAttr ".tgi[0].ni[11].x" 985.71429443359375;
	setAttr ".tgi[0].ni[11].y" 665.71429443359375;
	setAttr ".tgi[0].ni[11].nvs" 18305;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -762.28637158268612 -2072.6362840006082 ;
	setAttr ".tgi[1].vh" -type "double2" 702.71903949861553 -482.42903523357592 ;
	setAttr -s 13 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -1274.308837890625;
	setAttr ".tgi[1].ni[0].y" -1443.5133056640625;
	setAttr ".tgi[1].ni[0].nvs" 18305;
	setAttr ".tgi[1].ni[1].x" -648.45257568359375;
	setAttr ".tgi[1].ni[1].y" -769.3531494140625;
	setAttr ".tgi[1].ni[1].nvs" 18305;
	setAttr ".tgi[1].ni[2].x" -363.16250610351562;
	setAttr ".tgi[1].ni[2].y" -946.62060546875;
	setAttr ".tgi[1].ni[2].nvs" 18304;
	setAttr ".tgi[1].ni[3].x" -356.53414916992188;
	setAttr ".tgi[1].ni[3].y" -1413.94384765625;
	setAttr ".tgi[1].ni[3].nvs" 18305;
	setAttr ".tgi[1].ni[4].x" -1584.324951171875;
	setAttr ".tgi[1].ni[4].y" -1189.65771484375;
	setAttr ".tgi[1].ni[4].nvs" 18305;
	setAttr ".tgi[1].ni[5].x" -994.45611572265625;
	setAttr ".tgi[1].ni[5].y" -1771.93798828125;
	setAttr ".tgi[1].ni[5].nvs" 18304;
	setAttr ".tgi[1].ni[6].x" -40.22406005859375;
	setAttr ".tgi[1].ni[6].y" -994.9063720703125;
	setAttr ".tgi[1].ni[6].nvs" 18304;
	setAttr ".tgi[1].ni[7].x" -174.22187805175781;
	setAttr ".tgi[1].ni[7].y" -823.630615234375;
	setAttr ".tgi[1].ni[7].nvs" 18304;
	setAttr ".tgi[1].ni[8].x" 922.22100830078125;
	setAttr ".tgi[1].ni[8].y" -1096.0977783203125;
	setAttr ".tgi[1].ni[8].nvs" 18304;
	setAttr ".tgi[1].ni[9].x" -689.6279296875;
	setAttr ".tgi[1].ni[9].y" -1527.160400390625;
	setAttr ".tgi[1].ni[9].nvs" 18305;
	setAttr ".tgi[1].ni[10].x" -1430.029541015625;
	setAttr ".tgi[1].ni[10].y" -731.39361572265625;
	setAttr ".tgi[1].ni[10].nvs" 18305;
	setAttr ".tgi[1].ni[11].x" 370.36688232421875;
	setAttr ".tgi[1].ni[11].y" -1113.3077392578125;
	setAttr ".tgi[1].ni[11].nvs" 18305;
	setAttr ".tgi[1].ni[12].x" 700.79241943359375;
	setAttr ".tgi[1].ni[12].y" -1096.0977783203125;
	setAttr ".tgi[1].ni[12].nvs" 18304;
	setAttr ".tgi[2].tn" -type "string" "Untitled_3";
	setAttr ".tgi[2].vl" -type "double2" -669.0475924620564 -724.69416617002958 ;
	setAttr ".tgi[2].vh" -type "double2" 674.99997317791099 734.21797531539687 ;
	setAttr -s 4 ".tgi[2].ni";
	setAttr ".tgi[2].ni[0].x" 60;
	setAttr ".tgi[2].ni[0].y" 31.428571701049805;
	setAttr ".tgi[2].ni[0].nvs" 18304;
	setAttr ".tgi[2].ni[1].x" -247.14285278320312;
	setAttr ".tgi[2].ni[1].y" 31.428571701049805;
	setAttr ".tgi[2].ni[1].nvs" 18304;
	setAttr ".tgi[2].ni[2].x" -554.28570556640625;
	setAttr ".tgi[2].ni[2].y" 31.428571701049805;
	setAttr ".tgi[2].ni[2].nvs" 18304;
	setAttr ".tgi[2].ni[3].x" 367.14285278320312;
	setAttr ".tgi[2].ni[3].y" 31.428571701049805;
...
connectAttr "mirror_composeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "mute_mod_scaleX.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn";
connectAttr "negate.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn";
connectAttr "root_multMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn";
connectAttr "root_ctrJoint_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
...
connectAttr "root_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[9].dn"
		;
connectAttr "outJoints.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[10].dn";
connectAttr "root.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[11].dn";
connectAttr "root_ctrJoint_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn"
		;
...
connectAttr "outJoints.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[3].dn";
connectAttr "root.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn";
connectAttr "negate.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn";
...
connectAttr "root_multMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[11].dn"
		;
connectAttr "root_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[12].dn"
		;
connectAttr "root_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[0].dn"
		;
connectAttr "root_multMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[1].dn";
