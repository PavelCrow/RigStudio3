...
//Name: limb.ma
//Last modified: Sun, Apr 07, 2024 03:03:35 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "66997349-401A-724A-3213-F3947931B259";
createNode transform -s -n "persp";
	rename -uid "3C7E0AEC-41A5-B981-7A2B-32A67D2BBAA3";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.178125201142699 9.7790804798604345 20.006389739245595 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".ncp" 0.001;
	setAttr ".fcp" 50000;
	setAttr ".coi" 23.830796064990121;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "E0E21CF1-4211-75A3-F0FF-E79B0826D508";
	setAttr -s 3 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	...
	setAttr ".tgi[2].vl" -type "double2" -2440.3865943455507 -397.49586304407813 ;
	setAttr ".tgi[2].vh" -type "double2" -1530.3025862592742 531.07553948162422 ;
	setAttr -s 2 ".tgi[2].ni";
	setAttr ".tgi[2].ni[0].x" -2235.71435546875;
	setAttr ".tgi[2].ni[0].y" 92.857139587402344;
	setAttr ".tgi[2].ni[0].nvs" 18304;
	setAttr ".tgi[2].ni[1].x" -1928.5714111328125;
	setAttr ".tgi[2].ni[1].y" 92.857139587402344;
...
connectAttr "controls.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[1].dn";
