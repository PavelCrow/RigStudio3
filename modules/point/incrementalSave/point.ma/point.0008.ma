...
//Name: point.ma
//Last modified: Thu, Feb 22, 2024 07:05:56 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "6266D484-4829-A7D5-376B-34A7D7FF1791";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.5975977344450554 2.2602332834173993 17.526148102484569 ;
	setAttr ".r" -type "double3" -7.2000000000008386 11.600000000000023 1.0146472548830463e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 18.033785258630711;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "57F378E7-4BE9-5958-3EA6-79BC0F23809A";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "82F790CC-434D-CC4C-C1DD-41BD33D91B0B";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "AF6A6A62-4CB4-CD3C-4ACD-ABA22C576317";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "CE6ED7BD-4972-C5BE-2F64-A08CAF83757B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "089EBB66-47B5-48FA-9B52-F99DCCE464A4";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "A5BD83BF-4994-0964-5611-04889C5C2B77";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -1408.2417022832606 -1134.5237644418853 ;
	setAttr ".tgi[0].vh" -type "double2" 1993.9559647233527 -213.09522962759445 ;
	setAttr -s 6 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" -333.18215942382812;
	setAttr ".tgi[0].ni[0].y" -283.27438354492188;
	setAttr ".tgi[0].ni[0].nvs" 18305;
	setAttr ".tgi[0].ni[1].x" 340.92437744140625;
	setAttr ".tgi[0].ni[1].y" -652.85711669921875;
	setAttr ".tgi[0].ni[1].nvs" 18304;
	setAttr ".tgi[0].ni[2].x" 315.71429443359375;
	setAttr ".tgi[0].ni[2].y" -812.85711669921875;
	setAttr ".tgi[0].ni[2].nvs" 18304;
	setAttr ".tgi[0].ni[3].x" 150.8514404296875;
	setAttr ".tgi[0].ni[3].y" -323.61053466796875;
	setAttr ".tgi[0].ni[3].nvs" 18305;
	setAttr ".tgi[0].ni[4].x" 499.74789428710938;
	setAttr ".tgi[0].ni[4].y" -352.60504150390625;
	setAttr ".tgi[0].ni[4].nvs" 18305;
	setAttr ".tgi[0].ni[5].x" -151.93276977539062;
	setAttr ".tgi[0].ni[5].y" -538.1512451171875;
	setAttr ".tgi[0].ni[5].nvs" 18305;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -563.5154260578156 -308.99463702181691 ;
	setAttr ".tgi[1].vh" -type "double2" 683.734881439329 941.71385062550473 ;
	setAttr -s 5 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" 445.71429443359375;
	setAttr ".tgi[1].ni[0].y" 224.28572082519531;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" 445.71429443359375;
	setAttr ".tgi[1].ni[1].y" 354.28570556640625;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" -513.931396484375;
	setAttr ".tgi[1].ni[2].y" 280.51119995117188;
	setAttr ".tgi[1].ni[2].nvs" 18305;
	setAttr ".tgi[1].ni[3].x" -180.27584838867188;
	setAttr ".tgi[1].ni[3].y" 340.8857421875;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" 136.26597595214844;
	setAttr ".tgi[1].ni[4].y" 363.50753784179688;
...
connectAttr "root_poser_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
...
connectAttr "posers_bifrostGraph.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn"
		;
connectAttr ":initialShadingGroup.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn"
		;
connectAttr "root_poser.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn";
connectAttr "root_poser_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[3].dn"
		;
connectAttr "posers_bifrostGraphShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn"
		;
