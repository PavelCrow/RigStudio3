...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1D8594F3-4C00-19BE-3C9D-A3B74B1AFA1D";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "4A31559E-497D-A7FE-BD72-D4BBB5E5E837";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "4D110299-4AF3-A53A-E31E-989B3182D9DC";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "4907D9D1-4B19-BFB3-AA6D-D992A936FF1E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "362B8D33-439C-0D4E-C3CA-31B7BA796233";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	...
	setAttr ".tgi[0].vh" -type "double2" 4010.7141263428257 3345.1742596057034 ;
