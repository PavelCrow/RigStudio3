...
//Name: point.ma
//Last modified: Wed, Apr 03, 2024 06:08:55 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "4D674759-4F52-3015-A2DE-1A838AE90628";
...
createNode joint -n "root_initJoint" -p "root_poser";
	rename -uid "32E9C6C5-447A-8E0D-8514-86A455766CF2";
	setAttr -l on -k off ".v";
	setAttr ".uoc" 1;
	setAttr ".oc" 6;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.9259134559637987 15.26195125666862 20.95695092215966 ;
	setAttr ".r" -type "double3" -32.999999999665434 -339.60000000002208 -8.4834519310118867e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 26.966464181465213;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "50827431-4C10-3946-1803-FBAA1F8134FF";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "5724DDED-486D-AEAC-E794-03871090CFE3";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "EDC6F611-4BB7-A316-023A-0B9049835966";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "2E4A0303-4885-974E-8E6D-B69CCADD3E2E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "BA77BEC7-46D2-A2DA-DF09-87B499BF1C69";
...
connectAttr "negate.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn";
...
connectAttr "root_ctrJoint_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[7].dn"
		;
