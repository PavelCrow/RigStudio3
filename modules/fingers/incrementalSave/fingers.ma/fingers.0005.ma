...
//Name: fingers.ma
//Last modified: Mon, Jun 17, 2024 07:04:17 AM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "7880591E-4C79-F3D1-E206-56AC4082D7B5";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.0929535309748513 2.0694678117243921 2.5389848751370474 ;
	setAttr ".r" -type "double3" -36.600000000096664 35.999999999976701 1.9656908962214671e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".ncp" 0.001;
	setAttr ".fcp" 50000;
	setAttr ".coi" 3.5763775990932087;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "81F8B871-4A86-5845-642A-96BFE017D001";
	setAttr -s 3 ".tgi";
	...
	setAttr ".tgi[1].vl" -type "double2" 681.71449441836501 -5063.5746851432268 ;
	setAttr ".tgi[1].vh" -type "double2" 2293.2520833005351 -3565.8883641047091 ;
	setAttr -s 73 ".tgi[1].ni";
	...
	setAttr ".tgi[1].ni[24].x" 665.12115478515625;
	setAttr ".tgi[1].ni[24].y" -3793.98095703125;
	...
	setAttr ".tgi[1].ni[45].x" 1331.74658203125;
	setAttr ".tgi[1].ni[45].y" -3927.005126953125;
	...
	setAttr ".tgi[1].ni[69].x" 1321.717041015625;
	setAttr ".tgi[1].ni[69].y" -4076.1513671875;
	setAttr ".tgi[1].ni[69].nvs" 18304;
	setAttr ".tgi[1].ni[70].x" 920;
	setAttr ".tgi[1].ni[70].y" -4950;
	setAttr ".tgi[1].ni[70].nvs" 18304;
	setAttr ".tgi[1].ni[71].x" 1724.897216796875;
	setAttr ".tgi[1].ni[71].y" -4097.29931640625;
	setAttr ".tgi[1].ni[71].nvs" 18304;
	setAttr ".tgi[1].ni[72].x" 593.26910400390625;
	setAttr ".tgi[1].ni[72].y" -4201.2529296875;
	setAttr ".tgi[1].ni[72].nvs" 18305;
	setAttr ".tgi[2].tn" -type "string" "Untitled_3";
	setAttr ".tgi[2].vl" -type "double2" 1017.128083533347 -1100.2579748440883 ;
	setAttr ".tgi[2].vh" -type "double2" 2404.5230026011609 189.12081873869965 ;
	setAttr -s 6 ".tgi[2].ni";
	setAttr ".tgi[2].ni[0].x" 1757.142822265625;
	setAttr ".tgi[2].ni[0].y" -161.42857360839844;
	setAttr ".tgi[2].ni[0].nvs" 18304;
	setAttr ".tgi[2].ni[1].x" 1100.806884765625;
	setAttr ".tgi[2].ni[1].y" -374.96237182617188;
	setAttr ".tgi[2].ni[1].nvs" 18304;
	setAttr ".tgi[2].ni[2].x" 1427.7862548828125;
	setAttr ".tgi[2].ni[2].y" -266.35772705078125;
	setAttr ".tgi[2].ni[2].nvs" 18305;
	setAttr ".tgi[2].ni[3].x" 2082.857177734375;
	setAttr ".tgi[2].ni[3].y" -212.85714721679688;
	setAttr ".tgi[2].ni[3].nvs" 18305;
	setAttr ".tgi[2].ni[4].x" 1757.142822265625;
	setAttr ".tgi[2].ni[4].y" -262.85714721679688;
	setAttr ".tgi[2].ni[4].nvs" 18304;
	setAttr ".tgi[2].ni[5].x" 1106.64111328125;
	setAttr ".tgi[2].ni[5].y" -100.83871459960938;
...
connectAttr "makeNurbSphere17.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[68].dn"
		;
connectAttr "makeNurbSphere25.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[69].dn"
		;
connectAttr "root_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[70].dn"
		;
connectAttr "root_poserNurbsShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[71].dn"
		;
connectAttr "root_poser.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[72].dn";
...
connectAttr "thumbFinger_1_group_multMat.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[2].dn"
		;
connectAttr "thumbFinger_1_group.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[3].dn"
		;
connectAttr "thumbFinger_1_group_decMat.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[4].dn"
		;
connectAttr "thumbFingerA_poserOrient.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[5].dn"
		;
