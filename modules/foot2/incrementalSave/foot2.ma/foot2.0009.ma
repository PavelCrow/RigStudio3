...
//Name: foot2.ma
//Last modified: Mon, Jun 24, 2024 12:07:27 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "EEF3ACDE-46FA-F7FB-8AFD-748FCB8D2908";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "EA7BD3FA-482C-462F-06F6-F0BA560D0F2A";
	setAttr -s 23 ".lnk";
	setAttr -s 23 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "9BA2385F-4886-628B-7610-AFAE4E7E62AF";
createNode displayLayer -n "defaultLayer";
	rename -uid "19CE01F8-4DF6-369B-03C9-E4ACC39F3E53";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "92393621-4307-C389-232E-B99A3E1C817A";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1F34CFF6-45F3-0659-CA7B-9D8D363A3445";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "0E2990F0-4F31-3636-D926-49B12ED2B8DD";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "384F7421-42CD-B480-4297-29A39151B678";
	setAttr -s 3 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -434.52379225738537 -2405.8178013047486 ;
	setAttr ".tgi[0].vh" -type "double2" 3727.3808042681467 2111.7701939415319 ;
	...
	setAttr ".tgi[0].ni[3].x" 1295.7142333984375;
	...
	setAttr ".tgi[0].ni[6].x" 1627.8299560546875;
	setAttr ".tgi[0].ni[6].y" -187.4549560546875;
	...
	setAttr ".tgi[1].ni[6].y" -462.85714721679688;
	setAttr ".tgi[1].ni[6].nvs" 18304;
	setAttr ".tgi[2].tn" -type "string" "Untitled_3";
	setAttr ".tgi[2].vl" -type "double2" 1252.3809026158065 -1884.3465665298488 ;
	setAttr ".tgi[2].vh" -type "double2" 2251.1903867362071 -800.17713632057303 ;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -k on ".fzn";
	setAttr -av -k on ".ihi";
...
connectAttr "multDoubleLinear1624.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "toe_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn";
...
connectAttr "mainPoser_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "ik_toe_upv.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[6].dn";
...
connectAttr "toeTip_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[9].dn"
		;
connectAttr "toeBall_toeTip_distance.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[10].dn"
		;
connectAttr "toeTip_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[11].dn"
		;
...
connectAttr "toeTip_poserOrient_aimConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[3].dn"
		;
connectAttr "mainPoser_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn"
		;
connectAttr "root_poserOrient_aimConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn"
		;
connectAttr "toe_poserOrient_aimConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[6].dn"
		;
