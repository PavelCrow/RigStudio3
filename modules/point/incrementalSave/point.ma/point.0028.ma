...
//Name: point.ma
//Last modified: Thu, Jun 13, 2024 06:57:46 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "892785F3-436B-1FED-2C2F-FCA600F48E58";
...
createNode nurbsCurve -n "rootShape" -p "root";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		3.921799952071384 -2.4305044437536419e-15 3.921799952071416
		;
createNode joint -n "root_outJoint" -p "root";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.1395610269209193 6.4250178158610671 15.837255655533676 ;
	setAttr ".r" -type "double3" -17.399999999665724 -335.60000000001406 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 18.851115096876278;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "69BCC7EE-428B-9C25-19D6-A2B508F0442F";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "63A4473A-4A8E-F788-08BE-8682B64A8334";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "48F1C2D9-4A12-B416-A02B-8E998715724C";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "11844039-42BE-5657-5873-53B783C53B0A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "7138FE89-4014-F521-EA30-5F9F9178EC69";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "C650F1DB-4FCA-E0A6-C36E-5EA96BE23C6D";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 967.85710439795696 94.047615310502621 ;
	setAttr ".tgi[0].vh" -type "double2" 2189.2856272913195 1409.5237535143679 ;
	setAttr -s 2 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 1788.5714111328125;
	...
	setAttr ".tgi[1].vl" -type "double2" -718.52937243046028 -1537.1841231432591 ;
	setAttr ".tgi[1].vh" -type "double2" 375.61891015180618 -358.7885556448141 ;
	setAttr -s 11 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" 1130;
	setAttr ".tgi[1].ni[0].y" -945.71429443359375;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" -1020;
	setAttr ".tgi[1].ni[1].y" -838.5714111328125;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" -712.85711669921875;
	setAttr ".tgi[1].ni[2].y" -925.71429443359375;
	setAttr ".tgi[1].ni[2].nvs" 18304;
	setAttr ".tgi[1].ni[3].x" -1351.4285888671875;
	setAttr ".tgi[1].ni[3].y" -940;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" 208.57142639160156;
	setAttr ".tgi[1].ni[4].y" -931.4285888671875;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" -98.571426391601562;
	setAttr ".tgi[1].ni[5].y" -931.4285888671875;
	setAttr ".tgi[1].ni[5].nvs" 18304;
	setAttr ".tgi[1].ni[6].x" -1020;
	setAttr ".tgi[1].ni[6].y" -997.14288330078125;
	setAttr ".tgi[1].ni[6].nvs" 18304;
	setAttr ".tgi[1].ni[7].x" -98.571426391601562;
	setAttr ".tgi[1].ni[7].y" -830;
	setAttr ".tgi[1].ni[7].nvs" 18304;
	setAttr ".tgi[1].ni[8].x" 515.71429443359375;
	setAttr ".tgi[1].ni[8].y" -931.4285888671875;
	setAttr ".tgi[1].ni[8].nvs" 18304;
	setAttr ".tgi[1].ni[9].x" -1658.5714111328125;
	setAttr ".tgi[1].ni[9].y" -994.28570556640625;
	setAttr ".tgi[1].ni[9].nvs" 18304;
	setAttr ".tgi[1].ni[10].x" -405.71429443359375;
	setAttr ".tgi[1].ni[10].y" -925.71429443359375;
...
connectAttr "root_outJoint.wm" "root_multMatrix.i[1]";
connectAttr "outJoints.wim" "root_multMatrix.i[2]";
connectAttr "mute_mod_scaleX.o" "mirror_composeMatrix.isx";
connectAttr "root_outJoint.wm" "root_ctrJoint_decomposeMatrix.imat";
connectAttr "root_ctrJoint_decomposeMatrix.osz" "negate.i1";
connectAttr "root_outJoint.iog" "controlJointsSet.dsm" -na;
...
connectAttr "mute_mod_scaleX.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn";
connectAttr "outJointsSet.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn";
connectAttr "negate.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn";
connectAttr "mirror_condition.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn"
		;
connectAttr "root_ctrJoint_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[3].dn"
		;
connectAttr "root_multMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn";
connectAttr "mirror_composeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn"
		;
...
connectAttr "root_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[8].dn"
		;
connectAttr "root_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[9].dn";
connectAttr "mute_mod_scaleX.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[10].dn"
		;
