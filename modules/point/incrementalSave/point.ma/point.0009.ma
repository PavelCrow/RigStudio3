...
//Name: point.ma
//Last modified: Fri, Feb 23, 2024 01:51:11 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "473A2489-42DC-169E-F30E-77BBFD9CCA42";
...
createNode transform -n "root_init" -p "root_poser";
	rename -uid "D42C93A6-4720-DDFD-210D-80844B464A42";
	setAttr ".v" no;
createNode locator -n "root_initShape" -p "root_init";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 9.0301176186172469 13.599298545446167 19.023318660759085 ;
	setAttr ".r" -type "double3" -32.400000000001086 23.199999999999996 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 25.053513588538692;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B3EF13DB-47FE-A10A-50A7-BD81AB0B491E";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "D8B925DC-410D-8E76-9919-0384A98CCBBE";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "4587362D-474A-8A88-4650-1AA369F2237C";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "CC6BA946-4F13-C2AB-272C-49BECDDA5C2C";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "35E8C2DE-4F53-344A-B266-96992AB06A0C";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "B68B9BC3-46D9-83C0-0FC3-FA8D437230E0";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -1408.3332773711968 -2380.9088262608252 ;
	setAttr ".tgi[0].vh" -type "double2" 1995.2380159544596 1032.0993560481745 ;
	...
	setAttr ".tgi[1].vl" -type "double2" -541.42037004615599 -692.68162465198373 ;
	setAttr ".tgi[1].vh" -type "double2" 891.87885802122139 744.59163084996135 ;
	setAttr -s 7 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" 259.81817626953125;
	setAttr ".tgi[1].ni[0].y" 371.09091186523438;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" -645.71429443359375;
	setAttr ".tgi[1].ni[1].y" 247.14285278320312;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" -338.57144165039062;
	setAttr ".tgi[1].ni[2].y" 450;
	setAttr ".tgi[1].ni[2].nvs" 18304;
	setAttr ".tgi[1].ni[3].x" -338.57144165039062;
	setAttr ".tgi[1].ni[3].y" 247.14285278320312;
...
connectAttr "root_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn"
		;
connectAttr "mirror_condition.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn"
		;
connectAttr "outJoints.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn";
