...
//Name: point.ma
//Last modified: Wed, Jun 26, 2024 06:54:02 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "309D7254-42AE-2BED-675B-1DAFEB493E96";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1A2836C0-4907-B295-A8C1-14A69BDAD374";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "7F61C2FA-465F-2C94-6C85-53A3A09911E9";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "683F94C8-4360-5333-4D2D-ECA2317183DD";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "29E96F8C-46A9-D748-6246-D9A421304820";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "DE9EC31E-405A-D88F-DF64-2B9CE0B5FF06";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "9C12E14F-47D0-BBCA-9464-E4AB6C5057BF";
	setAttr -s 3 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 1297.023757984716 -132.73808996355748 ;
	setAttr ".tgi[0].vh" -type "double2" 2508.9284717327114 1182.7380482403078 ;
	setAttr -s 12 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 3467.142822265625;
	setAttr ".tgi[0].ni[0].y" 554.28570556640625;
	setAttr ".tgi[0].ni[0].nvs" 18305;
	setAttr ".tgi[0].ni[1].x" 1949.945556640625;
	setAttr ".tgi[0].ni[1].y" 897.53106689453125;
	...
	setAttr ".tgi[0].ni[4].x" 1624.2857666015625;
	...
	setAttr ".tgi[0].ni[6].y" 665.71429443359375;
	setAttr ".tgi[0].ni[6].nvs" 18305;
	setAttr ".tgi[0].ni[7].x" 3467.142822265625;
	setAttr ".tgi[0].ni[7].y" 974.28570556640625;
	setAttr ".tgi[0].ni[7].nvs" 18304;
	setAttr ".tgi[0].ni[8].x" 2238.571533203125;
	setAttr ".tgi[0].ni[8].y" 930;
	setAttr ".tgi[0].ni[8].nvs" 18304;
	setAttr ".tgi[0].ni[9].x" 2545.71435546875;
	setAttr ".tgi[0].ni[9].y" 930;
	setAttr ".tgi[0].ni[9].nvs" 18304;
	setAttr ".tgi[0].ni[10].x" 1621.8167724609375;
	setAttr ".tgi[0].ni[10].y" 763.82769775390625;
	setAttr ".tgi[0].ni[10].nvs" 18304;
	setAttr ".tgi[0].ni[11].x" 3160;
	setAttr ".tgi[0].ni[11].y" 974.28570556640625;
	setAttr ".tgi[0].ni[11].nvs" 18304;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -762.29473376859892 -2074.9999175469115 ;
	setAttr ".tgi[1].vh" -type "double2" 705.15187889639469 -482.14283798422201 ;
	setAttr -s 13 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -363.16250610351562;
	setAttr ".tgi[1].ni[0].y" -946.62060546875;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" -1584.324951171875;
	setAttr ".tgi[1].ni[1].y" -1189.65771484375;
	setAttr ".tgi[1].ni[1].nvs" 18305;
	setAttr ".tgi[1].ni[2].x" -40.22406005859375;
	setAttr ".tgi[1].ni[2].y" -994.9063720703125;
	setAttr ".tgi[1].ni[2].nvs" 18304;
	setAttr ".tgi[1].ni[3].x" 700.79241943359375;
	setAttr ".tgi[1].ni[3].y" -1096.0977783203125;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" -1430.029541015625;
	setAttr ".tgi[1].ni[4].y" -731.39361572265625;
	setAttr ".tgi[1].ni[4].nvs" 18305;
	setAttr ".tgi[1].ni[5].x" -648.45257568359375;
	setAttr ".tgi[1].ni[5].y" -769.3531494140625;
	setAttr ".tgi[1].ni[5].nvs" 18305;
	setAttr ".tgi[1].ni[6].x" 370.36688232421875;
	setAttr ".tgi[1].ni[6].y" -1113.3077392578125;
	setAttr ".tgi[1].ni[6].nvs" 18305;
	setAttr ".tgi[1].ni[7].x" -356.53414916992188;
	setAttr ".tgi[1].ni[7].y" -1413.94384765625;
	setAttr ".tgi[1].ni[7].nvs" 18305;
	setAttr ".tgi[1].ni[8].x" -994.45611572265625;
	setAttr ".tgi[1].ni[8].y" -1771.93798828125;
	setAttr ".tgi[1].ni[8].nvs" 18304;
	setAttr ".tgi[1].ni[9].x" -689.6279296875;
	setAttr ".tgi[1].ni[9].y" -1527.160400390625;
	setAttr ".tgi[1].ni[9].nvs" 18305;
	setAttr ".tgi[1].ni[10].x" -1274.308837890625;
	setAttr ".tgi[1].ni[10].y" -1443.5133056640625;
	setAttr ".tgi[1].ni[10].nvs" 18305;
	setAttr ".tgi[1].ni[11].x" -174.22187805175781;
	setAttr ".tgi[1].ni[11].y" -823.630615234375;
	setAttr ".tgi[1].ni[11].nvs" 18304;
	setAttr ".tgi[1].ni[12].x" 922.22100830078125;
	setAttr ".tgi[1].ni[12].y" -1096.0977783203125;
	setAttr ".tgi[1].ni[12].nvs" 18304;
	setAttr ".tgi[2].tn" -type "string" "Untitled_3";
	setAttr ".tgi[2].vl" -type "double2" -554.06420236192207 -1129.3660241330058 ;
	setAttr ".tgi[2].vh" -type "double2" 605.10287812126319 128.86543356239673 ;
	setAttr -s 8 ".tgi[2].ni";
	setAttr ".tgi[2].ni[0].x" -140;
	setAttr ".tgi[2].ni[0].y" -217.14285278320312;
	setAttr ".tgi[2].ni[0].nvs" 18304;
	setAttr ".tgi[2].ni[1].x" 781.4285888671875;
	setAttr ".tgi[2].ni[1].y" -261.42855834960938;
	setAttr ".tgi[2].ni[1].nvs" 18304;
	setAttr ".tgi[2].ni[2].x" 167.14285278320312;
	setAttr ".tgi[2].ni[2].y" -217.14285278320312;
	setAttr ".tgi[2].ni[2].nvs" 18304;
	setAttr ".tgi[2].ni[3].x" -87.67572021484375;
	setAttr ".tgi[2].ni[3].y" -452.63845825195312;
	setAttr ".tgi[2].ni[3].nvs" 18304;
	setAttr ".tgi[2].ni[4].x" 474.28570556640625;
	setAttr ".tgi[2].ni[4].y" -217.14285278320312;
	setAttr ".tgi[2].ni[4].nvs" 18304;
	setAttr ".tgi[2].ni[5].x" 1088.5714111328125;
	setAttr ".tgi[2].ni[5].y" -261.42855834960938;
	setAttr ".tgi[2].ni[5].nvs" 18304;
	setAttr ".tgi[2].ni[6].x" -754.28570556640625;
	setAttr ".tgi[2].ni[6].y" -188.57142639160156;
	setAttr ".tgi[2].ni[6].nvs" 18304;
	setAttr ".tgi[2].ni[7].x" -447.14285278320312;
	setAttr ".tgi[2].ni[7].y" -188.57142639160156;
...
connectAttr "negate.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn";
connectAttr "root_ctrJoint_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "root.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[6].dn";
connectAttr "root_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[7].dn";
connectAttr "mute_mod_scaleX.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[8].dn";
connectAttr "mirror_composeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[9].dn"
		;
connectAttr "mod.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[10].dn";
connectAttr "root_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[11].dn"
		;
...
connectAttr "mirror_condition.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn"
		;
connectAttr "root_multMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[6].dn";
...
connectAttr "mirror_condition_2.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[9].dn"
		;
connectAttr "root_ctrJoint_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[10].dn"
		;
connectAttr "root_initLoc.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[11].dn";
connectAttr "root_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[12].dn";
connectAttr "mute_mod_scaleX.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[0].dn";
connectAttr "root_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[1].dn"
		;
connectAttr "mirror_composeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[2].dn"
		;
connectAttr "root_initLoc.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[3].dn";
connectAttr "root_multMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[4].dn";
...
connectAttr "mirror_condition.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[7].dn"
		;
