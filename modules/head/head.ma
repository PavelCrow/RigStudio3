...
//Name: head.ma
//Last modified: Fri, Aug 09, 2024 01:54:26 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "87A4A212-4CEF-6532-436B-3EBDC26BBD71";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.3663991179406993 3.8374870190189609 7.2953362654152922 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 9.8069609995028557;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "C0A4544B-450C-6FB7-83FE-7AAC521C0C83";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	...
	setAttr ".tgi[1].vl" -type "double2" -355.04656086253436 -811.92601536528468 ;
	setAttr ".tgi[1].vh" -type "double2" 600.19300634479214 153.80108597423569 ;
	setAttr -s 7 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -36.050731658935547;
	setAttr ".tgi[1].ni[0].y" -377.56732177734375;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" -78.571426391601562;
	setAttr ".tgi[1].ni[1].y" -544.28570556640625;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" -292.69192504882812;
	setAttr ".tgi[1].ni[2].y" -239.49348449707031;
	setAttr ".tgi[1].ni[2].nvs" 18305;
	setAttr ".tgi[1].ni[3].x" 361.21652221679688;
	setAttr ".tgi[1].ni[3].y" -191.98619079589844;
	setAttr ".tgi[1].ni[3].nvs" 18305;
	setAttr ".tgi[1].ni[4].x" -171.42857360839844;
	setAttr ".tgi[1].ni[4].y" -137.14285278320312;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" -171.42857360839844;
	setAttr ".tgi[1].ni[5].y" 65.714286804199219;
	setAttr ".tgi[1].ni[5].nvs" 18304;
	setAttr ".tgi[1].ni[6].x" 135.71427917480469;
	setAttr ".tgi[1].ni[6].y" -35.714286804199219;
...
connectAttr "controlShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn";
connectAttr "control.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn";
connectAttr "root_group.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[3].dn";
connectAttr "world_connector.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn";
connectAttr "root_connector.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn";
connectAttr "root_group_orientConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[6].dn"
		;
