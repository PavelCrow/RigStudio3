...
//Name: point.ma
//Last modified: Sun, Apr 07, 2024 02:47:39 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "9552D6B3-4FD7-816D-3CE9-598E560BA383";
...
createNode nurbsSurface -n "root_poserShape" -p "root_poser";
	...
	setAttr ".nufa" 4.5;
	setAttr ".nvfa" 4.5;
createNode transform -n "root_iniLoc" -p "root_poser";
	rename -uid "DFB53D08-4656-00F0-34A1-6297C7446241";
	setAttr ".v" no;
createNode locator -n "root_iniLocShape" -p "root_iniLoc";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.5943446355082465 7.7198385272692764 10.842517039970179 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 13.934132638883478;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6BE567AB-4981-F341-E70D-1A8A5D7BB263";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "29EDBA45-4397-FCB6-44D2-9F9242492E90";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "96B9EAA2-428A-150A-3E89-BFA81B9D6456";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "8ED97CEA-4312-AD13-8208-9ABA9236629F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "1C8F013D-4C03-8DC7-367A-A2A6D108A2B2";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "51B4B770-4C05-3EEE-4C1E-F1AB8B933932";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -380.76921563882155 346.42855766273738 ;
	setAttr ".tgi[0].vh" -type "double2" 2995.0548260421597 1260.7142356180032 ;
	setAttr ".tgi[0].ni[0].x" 1052.857177734375;
	setAttr ".tgi[0].ni[0].y" 834.28570556640625;
	setAttr ".tgi[0].ni[0].nvs" 18304;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -1488.7587956647294 -1169.1502612795152 ;
	setAttr ".tgi[1].vh" -type "double2" -578.67478757845288 -240.57885875381277 ;
	setAttr ".tgi[1].ni[0].x" -977.14288330078125;
	setAttr ".tgi[1].ni[0].y" -678.5714111328125;
