...
//Name: limb.ma
//Last modified: Sun, Apr 07, 2024 03:02:41 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "761130A5-4DB4-FFBF-7E05-158B56902192";
createNode transform -s -n "persp";
	rename -uid "3C7E0AEC-41A5-B981-7A2B-32A67D2BBAA3";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 14.175871904828615 4.9027237448563259 8.5950991301284621 ;
	setAttr ".r" -type "double3" -18.600000000008713 44.000000000003347 2.2107456587042398e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".ncp" 0.001;
	setAttr ".fcp" 50000;
	setAttr ".coi" 15.954568291133796;
...
createNode transform -n "mainPoser" -p "posers";
	...
	setAttr ".ove" yes;
	setAttr ".ovc" 12;
	setAttr ".t" -type "double3" 0.090846787204604595 0.86481790354260291 -0.45010441373467813 ;
	setAttr ".r" -type "double3" 5.717828345947078 2.3920334072610552 2.3542607603237649 ;
	setAttr -k on ".s";
	setAttr -k off ".sy";
	setAttr -k off ".sz";
	setAttr -k on ".size";
...
createNode transform -n "middle_poser" -p "mainPoser";
	...
	setAttr ".ove" yes;
	setAttr ".ovc" 4;
	setAttr -k on ".t" -type "double3" 4.9849322612836584 0.70562034725608014 -2.5691968394562132 ;
	setAttr -k on ".t";
...
createNode orientConstraint -n "middleRoot_orient_locator_orientConstraint1" -p "middleOffset_initLoc";
	...
	setAttr ".erp" yes;
	setAttr -s 2 ".tg";
	setAttr ".lr" -type "double3" 11.067869268382919 3.1115410545140545 2.9450010201764671 ;
...
createNode transform -n "end_poser" -p "mainPoser";
	...
	setAttr ".ove" yes;
	setAttr ".ovc" 4;
	setAttr -k on ".t" -type "double3" 10.26743877213541 0.52796805966957339 -0.55763290909626451 ;
	setAttr -k on ".t";
	setAttr -k on ".r";
	setAttr -l on -k off ".sx";
	setAttr -l on -k off ".sy";
...
createNode orientConstraint -n "middle_line_endOrient_locator_orientConstraint1" 
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".lr" -type "double3" 11.835452577465487 -20.835928323086637 -1.9261484127460535 ;
...
createNode nurbsCurve -n "fk_aShape" -p "fk_a";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		-1.740280630679319e-16 -1.012392778362831e-16 -0.72377410418209487
...
createNode transform -n "fk_b_group" -p "fk_a";
	...
	setAttr ".t" -type "double3" 5.6522758357957184 0 1.6653345369377348e-16 ;
...
createNode nurbsCurve -n "aim_curveShape" -p "aim_curve";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		2 0 1
		2
		4.9242007731072412 2.0224169435176007 -3.1421068250993152
		4.5671324729919434 2.8998117446899414 -6.1148290634155273
		;
...
createNode orientConstraint -n "middle_control_orientConstraint1" -p "middleOffset_group";
	...
	setAttr ".erp" yes;
	setAttr -s 2 ".tg";
	setAttr ".lr" -type "double3" 1.6235540969614933e-06 -24.418900141296561 -3.1813545914649732e-07 ;
...
createNode joint -n "a_ikJoint" -p "ik_joints";
	...
	setAttr ".oc" 6;
	setAttr ".r" -type "double3" 3.109431811723974e-06 7.393896629035605e-06 1.412198982478106e-06 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
createNode joint -n "b_ikJoint" -p "a_ikJoint";
	rename -uid "36C349D0-4D4F-1ABF-EC19-7189F801D31E";
	setAttr ".oc" 6;
	setAttr ".t" -type "double3" 5.6522760391235352 0 -1.6653345369377336e-15 ;
	setAttr ".r" -type "double3" 0 -43.83781565256831 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode parentConstraint -n "end_joint_parentConstraint1" -p "end_finalJoint";
	...
	setAttr ".erp" yes;
	setAttr -s 2 ".tg";
	setAttr ".lr" -type "double3" -15.054214244051277 19.30361828427619 -3.2970477395967013 ;
...
createNode parentConstraint -n "b_joint_parentConstraint1" -p "b_finalJoint";
	...
	setAttr ".erp" yes;
	setAttr -s 2 ".tg";
	setAttr ".lr" -type "double3" 8.185552051517579e-14 -48.837807676489788 -8.8915199647650032e-07 ;
...
createNode parentConstraint -n "a_joint_parentConstraint1" -p "a_finalJoint";
	...
	setAttr ".erp" yes;
	setAttr -s 2 ".tg";
	setAttr ".lr" -type "double3" 19.247054166450944 28.441990585521953 13.468763203479105 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "16B2B574-440F-4C39-84B3-43AF3BB5DEA6";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "1A78DCC0-452E-FCF2-74A8-A2946890C4B6";
	setAttr ".cdl" 5;
	setAttr -s 5 ".dli[1:4]"  5 3 2 4;
createNode displayLayer -n "defaultLayer";
	rename -uid "B15E876D-47C6-71D4-FBBA-048077D00CDF";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B4C80083-43EE-BB10-1807-94A6BC95EC34";
...
createNode plusMinusAverage -n "one_minus";
	...
	setAttr ".op" 2;
	setAttr -s 2 ".i1[0:1]"  1 71.61380005;
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A540FB8B-4DF2-8006-0659-CDB64FC6B221";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "99E63D04-4894-7E2D-D176-7888F99E7AFE";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "402AFAE8-4BF0-C929-EE55-50B34CD442C0";
	setAttr -s 3 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -4631.1811346547029 -1102.3809085762709 ;
	setAttr ".tgi[0].vh" -type "double2" 977.60985126317803 416.6666501098216 ;
	setAttr -s 7 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" -1617.0753173828125;
	setAttr ".tgi[0].ni[0].y" -690.0511474609375;
	...
	setAttr ".tgi[0].ni[4].y" -502.85714721679688;
	setAttr ".tgi[0].ni[4].nvs" 18304;
	setAttr ".tgi[0].ni[5].x" -2115.71435546875;
	setAttr ".tgi[0].ni[5].y" -298.57144165039062;
	setAttr ".tgi[0].ni[5].nvs" 18304;
	setAttr ".tgi[0].ni[6].x" -2422.857177734375;
	setAttr ".tgi[0].ni[6].y" -147.14285278320312;
	setAttr ".tgi[0].ni[6].nvs" 18305;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -6868.0400201289031 -99.999996026357081 ;
	setAttr ".tgi[1].vh" -type "double2" -3615.2928966342088 780.95234992012274 ;
	setAttr -s 40 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -4438.5712890625;
	setAttr ".tgi[1].ni[0].y" 422.85714721679688;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" 1485.7142333984375;
	setAttr ".tgi[1].ni[1].y" 190;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" 831.4285888671875;
	setAttr ".tgi[1].ni[2].y" 197.14285278320312;
	setAttr ".tgi[1].ni[2].nvs" 18304;
	setAttr ".tgi[1].ni[3].x" 1485.7142333984375;
	setAttr ".tgi[1].ni[3].y" 392.85714721679688;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" 1485.7142333984375;
	setAttr ".tgi[1].ni[4].y" -317.14285278320312;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" -5052.85693359375;
	setAttr ".tgi[1].ni[5].y" 417.14285278320312;
	setAttr ".tgi[1].ni[5].nvs" 18304;
	setAttr ".tgi[1].ni[6].x" 1141.4285888671875;
	setAttr ".tgi[1].ni[6].y" -70;
	setAttr ".tgi[1].ni[6].nvs" 18304;
	setAttr ".tgi[1].ni[7].x" -1674.2857666015625;
	setAttr ".tgi[1].ni[7].y" 231.42857360839844;
	setAttr ".tgi[1].ni[7].nvs" 18304;
	setAttr ".tgi[1].ni[8].x" -1981.4285888671875;
	setAttr ".tgi[1].ni[8].y" 240;
	setAttr ".tgi[1].ni[8].nvs" 18304;
	setAttr ".tgi[1].ni[9].x" -2902.857177734375;
	setAttr ".tgi[1].ni[9].y" 374.28570556640625;
	setAttr ".tgi[1].ni[9].nvs" 18304;
	setAttr ".tgi[1].ni[10].x" 831.4285888671875;
	setAttr ".tgi[1].ni[10].y" -5.7142858505249023;
	setAttr ".tgi[1].ni[10].nvs" 18304;
	setAttr ".tgi[1].ni[11].x" 1141.4285888671875;
	setAttr ".tgi[1].ni[11].y" -228.57142639160156;
	setAttr ".tgi[1].ni[11].nvs" 18304;
	setAttr ".tgi[1].ni[12].x" 1141.4285888671875;
	setAttr ".tgi[1].ni[12].y" 234.28572082519531;
	setAttr ".tgi[1].ni[12].nvs" 18304;
	setAttr ".tgi[1].ni[13].x" -3210;
	setAttr ".tgi[1].ni[13].y" 382.85714721679688;
	setAttr ".tgi[1].ni[13].nvs" 18304;
	setAttr ".tgi[1].ni[14].x" -90;
	setAttr ".tgi[1].ni[14].y" 237.14285278320312;
	setAttr ".tgi[1].ni[14].nvs" 18304;
	setAttr ".tgi[1].ni[15].x" 1485.7142333984375;
	setAttr ".tgi[1].ni[15].y" 494.28570556640625;
	setAttr ".tgi[1].ni[15].nvs" 18304;
	setAttr ".tgi[1].ni[16].x" 217.14285278320312;
	setAttr ".tgi[1].ni[16].y" 220;
	setAttr ".tgi[1].ni[16].nvs" 18304;
	setAttr ".tgi[1].ni[17].x" -1060;
	setAttr ".tgi[1].ni[17].y" 211.42857360839844;
	setAttr ".tgi[1].ni[17].nvs" 18304;
	setAttr ".tgi[1].ni[18].x" 524.28570556640625;
	setAttr ".tgi[1].ni[18].y" 207.14285278320312;
	setAttr ".tgi[1].ni[18].nvs" 18304;
	setAttr ".tgi[1].ni[19].x" 831.4285888671875;
	setAttr ".tgi[1].ni[19].y" -184.28572082519531;
	setAttr ".tgi[1].ni[19].nvs" 18304;
	setAttr ".tgi[1].ni[20].x" 1485.7142333984375;
	setAttr ".tgi[1].ni[20].y" -114.28571319580078;
	setAttr ".tgi[1].ni[20].nvs" 18304;
	setAttr ".tgi[1].ni[21].x" 1485.7142333984375;
	setAttr ".tgi[1].ni[21].y" -12.857142448425293;
	setAttr ".tgi[1].ni[21].nvs" 18304;
	setAttr ".tgi[1].ni[22].x" 1141.4285888671875;
	setAttr ".tgi[1].ni[22].y" 335.71429443359375;
	setAttr ".tgi[1].ni[22].nvs" 18304;
	setAttr ".tgi[1].ni[23].x" -1367.142822265625;
	setAttr ".tgi[1].ni[23].y" 222.85714721679688;
	setAttr ".tgi[1].ni[23].nvs" 18304;
	setAttr ".tgi[1].ni[24].x" -752.85711669921875;
	setAttr ".tgi[1].ni[24].y" 304.28570556640625;
	setAttr ".tgi[1].ni[24].nvs" 18304;
	setAttr ".tgi[1].ni[25].x" -2595.71435546875;
	setAttr ".tgi[1].ni[25].y" 364.28570556640625;
	...
	setAttr ".tgi[1].ni[27].x" -4745.71435546875;
	setAttr ".tgi[1].ni[27].y" 432.85714721679688;
	setAttr ".tgi[1].ni[27].nvs" 18304;
	setAttr ".tgi[1].ni[28].x" 1485.7142333984375;
	setAttr ".tgi[1].ni[28].y" 595.71429443359375;
	setAttr ".tgi[1].ni[28].nvs" 18304;
	setAttr ".tgi[1].ni[29].x" -3824.28564453125;
	setAttr ".tgi[1].ni[29].y" 402.85714721679688;
	setAttr ".tgi[1].ni[29].nvs" 18304;
	setAttr ".tgi[1].ni[30].x" -5402.85693359375;
	setAttr ".tgi[1].ni[30].y" 398.57144165039062;
	setAttr ".tgi[1].ni[30].nvs" 18305;
	setAttr ".tgi[1].ni[31].x" 1141.4285888671875;
	setAttr ".tgi[1].ni[31].y" 31.428571701049805;
	setAttr ".tgi[1].ni[31].nvs" 18304;
	setAttr ".tgi[1].ni[32].x" 1485.7142333984375;
	setAttr ".tgi[1].ni[32].y" 291.42855834960938;
	setAttr ".tgi[1].ni[32].nvs" 18304;
	setAttr ".tgi[1].ni[33].x" 524.28570556640625;
	setAttr ".tgi[1].ni[33].y" 308.57144165039062;
	setAttr ".tgi[1].ni[33].nvs" 18304;
	setAttr ".tgi[1].ni[34].x" -4131.4287109375;
	setAttr ".tgi[1].ni[34].y" 412.85714721679688;
	setAttr ".tgi[1].ni[34].nvs" 18304;
	setAttr ".tgi[1].ni[35].x" -397.14285278320312;
	setAttr ".tgi[1].ni[35].y" 268.57144165039062;
	setAttr ".tgi[1].ni[35].nvs" 18304;
	setAttr ".tgi[1].ni[36].x" 1485.7142333984375;
	setAttr ".tgi[1].ni[36].y" -215.71427917480469;
	setAttr ".tgi[1].ni[36].nvs" 18304;
	setAttr ".tgi[1].ni[37].x" -752.85711669921875;
	setAttr ".tgi[1].ni[37].y" 202.85714721679688;
	setAttr ".tgi[1].ni[37].nvs" 18304;
	setAttr ".tgi[1].ni[38].x" -3517.142822265625;
	setAttr ".tgi[1].ni[38].y" 392.85714721679688;
	setAttr ".tgi[1].ni[38].nvs" 18304;
	setAttr ".tgi[1].ni[39].x" -2288.571533203125;
	setAttr ".tgi[1].ni[39].y" 302.85714721679688;
	setAttr ".tgi[1].ni[39].nvs" 18304;
	setAttr ".tgi[2].tn" -type "string" "Untitled_3";
	setAttr ".tgi[2].vl" -type "double2" -2443.327770733641 -405.05888804202499 ;
	setAttr ".tgi[2].vh" -type "double2" -1533.2437626473647 523.51251448367736 ;
	setAttr ".tgi[2].ni[0].x" -2238.571533203125;
	setAttr ".tgi[2].ni[0].y" 150;
...
connectAttr "input.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn";
...
connectAttr "size_multiplyDivide.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "mainPoser.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[6].dn";
connectAttr "length_difference_minus.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn"
		;
connectAttr "middleOffset_group.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn"
		;
connectAttr "middle_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn";
connectAttr "controls.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[3].dn";
connectAttr "middle_volume_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn"
		;
connectAttr "current_length_scaled.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn"
		;
connectAttr "end_finalJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[6].dn";
connectAttr "stretch_blend.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[7].dn";
connectAttr "final_length_factor.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[8].dn"
		;
connectAttr "return_softIk.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[9].dn";
connectAttr "end_joint_parentConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[10].dn"
		;
connectAttr "joints.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[11].dn";
connectAttr "middle_control_pointConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[12].dn"
		;
connectAttr "one_minus_by_softIk.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[13].dn"
		;
connectAttr "b_ikJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[14].dn";
connectAttr "root_volume_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[15].dn"
		;
connectAttr "b_joint_parentConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[16].dn"
		;
connectAttr "final_length.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[17].dn";
connectAttr "b_finalJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[18].dn";
connectAttr "multDoubleLinear435.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[19].dn"
		;
connectAttr "end_out.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[20].dn";
connectAttr "end_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[21].dn";
connectAttr "middle_control_orientConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[22].dn"
		;
connectAttr "ikfk_blend.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[23].dn";
connectAttr "current_toSnapPoint_length_scaled.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[24].dn"
		;
connectAttr "softIk_condition.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[25].dn"
		;
connectAttr "volume_mult.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[26].dn";
connectAttr "length_difference.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[27].dn"
		;
connectAttr "effector.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[28].dn";
connectAttr "power.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[29].dn";
connectAttr "root_connector_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[30].dn"
		;
connectAttr "volume_blendColors.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[31].dn"
		;
connectAttr "ik_joints.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[32].dn";
connectAttr "end_ikJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[33].dn";
connectAttr "length_difference_by_softIk.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[34].dn"
		;
connectAttr "snap_blend.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[35].dn";
connectAttr "outJoints.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[36].dn";
connectAttr "scale_to_translate_converter.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[37].dn"
		;
connectAttr "one_minus.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[38].dn";
connectAttr "stretch_condition.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[39].dn"
		;
