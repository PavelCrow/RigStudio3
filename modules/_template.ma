...
//Name: _template.ma
//Last modified: Sat, Aug 10, 2024 06:13:19 AM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "F3A37EBA-4483-2535-E6C8-2C8C9C8FF57D";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.9742065528381199 2.707478731060645 5.3124315458912532 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 7.1656603138543895;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4710648C-451C-19F0-523B-24A1106BA8CD";
	setAttr -s 6 ".lnk";
	setAttr -s 6 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "D86C5F33-48B3-E8D6-D806-D6A03B0F6DA7";
createNode displayLayer -n "defaultLayer";
	rename -uid "47598A7F-4076-9A26-4738-16A1F08E3130";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D43E459B-491C-22FB-771D-18915042FCAE";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A172E78F-40EF-92A2-BEEB-FE8B56FDF107";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "4ED36790-4A18-DD8D-4800-CD802B737D1D";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "62B02A06-4AEC-C189-AACE-E882C103F9F6";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 870.60775726226962 -2225.0773453198276 ;
	setAttr ".tgi[0].vh" -type "double2" 1789.0951264573762 -1296.5059427941253 ;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -av -k on ".ihi";
	setAttr -av -k on ".nds";
...
connectAttr "size_multiplyDivide.oy" "makeNurbSphere1.r";
