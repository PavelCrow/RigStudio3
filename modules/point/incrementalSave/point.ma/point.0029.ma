...
//Name: point.ma
//Last modified: Thu, Jun 13, 2024 07:02:20 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "EC416FEC-4091-DD86-206C-518487A281CE";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.8396435072720827 6.956100357627947 17.380578917265993 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 20.627068597300287;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "E3DB8CF4-458A-6922-CC18-7B8A835B9B34";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	...
	setAttr ".tgi[1].ni[1].x" 822.85711669921875;
	setAttr ".tgi[1].ni[1].y" -848.5714111328125;
	setAttr ".tgi[1].ni[1].nvs" 18305;
	setAttr ".tgi[1].ni[2].x" -1020;
	setAttr ".tgi[1].ni[2].y" -838.5714111328125;
	setAttr ".tgi[1].ni[2].nvs" 18304;
	setAttr ".tgi[1].ni[3].x" -712.85711669921875;
	setAttr ".tgi[1].ni[3].y" -925.71429443359375;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" -1351.4285888671875;
	setAttr ".tgi[1].ni[4].y" -940;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" 208.57142639160156;
	setAttr ".tgi[1].ni[5].y" -931.4285888671875;
	setAttr ".tgi[1].ni[5].nvs" 18304;
	setAttr ".tgi[1].ni[6].x" -98.571426391601562;
	setAttr ".tgi[1].ni[6].y" -931.4285888671875;
	setAttr ".tgi[1].ni[6].nvs" 18304;
	setAttr ".tgi[1].ni[7].x" -1020;
	setAttr ".tgi[1].ni[7].y" -997.14288330078125;
	setAttr ".tgi[1].ni[7].nvs" 18304;
	setAttr ".tgi[1].ni[8].x" -98.571426391601562;
	setAttr ".tgi[1].ni[8].y" -830;
	setAttr ".tgi[1].ni[8].nvs" 18304;
	setAttr ".tgi[1].ni[9].x" 515.71429443359375;
	setAttr ".tgi[1].ni[9].y" -931.4285888671875;
	setAttr ".tgi[1].ni[9].nvs" 18304;
	setAttr ".tgi[1].ni[10].x" -1658.5714111328125;
	setAttr ".tgi[1].ni[10].y" -994.28570556640625;
	setAttr ".tgi[1].ni[10].nvs" 18304;
	setAttr ".tgi[1].ni[11].x" -405.71429443359375;
	setAttr ".tgi[1].ni[11].y" -925.71429443359375;
...
connectAttr "outJoints.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[8].dn";
connectAttr "root_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[9].dn"
		;
connectAttr "root_ctrJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[10].dn";
connectAttr "mute_mod_scaleX.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[11].dn"
		;
