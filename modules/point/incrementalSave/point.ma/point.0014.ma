...
//Name: point.ma
//Last modified: Sat, Feb 24, 2024 03:54:31 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "078479E3-4AC1-2488-444F-34B3E054C5DF";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 13.032569065615789 10.487211283134071 -10.781478771945023 ;
	setAttr ".r" -type "double3" -31.79999999996922 -230.3999999999676 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 19.901500985030623;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "4EE19B19-4054-1ECC-5667-FBAAEE017CC0";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
