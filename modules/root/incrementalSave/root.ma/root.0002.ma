...
//Name: root.ma
//Last modified: Sat, Feb 24, 2024 04:01:03 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "1FBACFA4-49BA-526B-2DCD-029CA3EBD630";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.7402563578826911 5.0436390311059567 8.383427926128066 ;
	setAttr ".r" -type "double3" -26.40000000001087 -325.59999999998206 1.9273437461033127e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 11.343318672924601;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "DC602DB6-4CB6-8396-8763-C58B61C72F2C";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "8073ABB9-4B16-F7F7-D16E-329921289B97";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "165EDBDC-4BB4-5E02-F3E5-E7B1B15CF2E8";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "312CC772-4732-FA2E-8204-8D9EA41D838A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F32515DF-4A7A-720D-18EA-849B55C91084";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "48D253D9-45B8-92CE-D7C0-94BFE403E14E";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 459.23055703902253 80.952377735622719 ;
	setAttr ".tgi[0].vh" -type "double2" 2112.1979122101625 1553.5713668380492 ;
	setAttr -s 7 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 1823.175537109375;
	setAttr ".tgi[0].ni[0].y" 922.850341796875;
	setAttr ".tgi[0].ni[0].nvs" 18305;
	setAttr ".tgi[0].ni[1].x" 574.28570556640625;
	setAttr ".tgi[0].ni[1].y" 945.71429443359375;
	...
	setAttr ".tgi[0].ni[5].x" 817.76416015625;
	setAttr ".tgi[0].ni[5].y" 764.36651611328125;
	setAttr ".tgi[0].ni[5].nvs" 18305;
	setAttr ".tgi[0].ni[6].x" 1188.5714111328125;
	setAttr ".tgi[0].ni[6].y" 842.93115234375;
	setAttr ".tgi[0].ni[6].nvs" 18304;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -772.85385280093487 -881.66274291665513 ;
	setAttr ".tgi[1].vh" -type "double2" 571.60370912173732 316.10666827942509 ;
	setAttr -s 6 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -724.28570556640625;
	setAttr ".tgi[1].ni[0].y" 34.285713195800781;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" -110;
	setAttr ".tgi[1].ni[1].y" 85.714286804199219;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" -724.28570556640625;
	setAttr ".tgi[1].ni[2].y" 135.71427917480469;
	setAttr ".tgi[1].ni[2].nvs" 18304;
	setAttr ".tgi[1].ni[3].x" -417.14285278320312;
	setAttr ".tgi[1].ni[3].y" 85.714286804199219;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" 197.14285278320312;
	setAttr ".tgi[1].ni[4].y" 107.14286041259766;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" 197.14285278320312;
...
connectAttr "multiplyDivide1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "root_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn";
...
connectAttr "root_multMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[6].dn";
connectAttr "mainPoser.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn";
connectAttr "posers_bifrostGraphShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn"
		;
connectAttr "root_poser.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn";
connectAttr "multiplyDivide1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[3].dn";
connectAttr "mainPoserShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn";
connectAttr "posers_bifrostGraph.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn"
		;
