...
//Name: fingers.ma
//Last modified: Fri, Sep 06, 2024 08:57:47 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "39DB150D-4857-D296-E69C-FC90A8418759";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.4466155815757347 2.111049799093129 -1.4236218333433934 ;
	setAttr ".r" -type "double3" -44.399999999985944 135.19999999999743 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".ncp" 0.001;
	setAttr ".fcp" 50000;
	setAttr ".coi" 3.1592903863809068;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D39BA7F2-4D93-9CA6-85EE-839B9BDA9ADE";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "D27980AA-478E-1FFA-19D6-CCAD2B41F9EA";
createNode displayLayer -n "defaultLayer";
	rename -uid "E07D4D85-463A-EC21-D440-F88CC183AD0E";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "4ADB8A2B-4E3D-CE38-21D5-EEA7716110B6";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9CBA9C8C-41F4-458B-C587-29B5FA4393C1";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "68CC46C5-447E-AC70-2352-828B4D03BD36";
