...
//Name: point.ma
//Last modified: Tue, Jan 07, 2025 07:07:07 AM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "F9463502-457B-5F48-9060-469615A12F4B";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.4274532966251812 11.89930337228593 19.747485275015695 ;
	setAttr ".r" -type "double3" -30.600000000001607 -335.60000000001821 -8.7312280277640302e-16 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F9A9BF21-4C6D-9CC4-2280-299978249DAC";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "98A4A28C-4FFB-CADA-9C6A-0398A573BB9B";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0A667A97-4C74-9D08-2E7E-1C93F4EFF12D";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "5BBBFF96-4BE7-4337-BDC5-A8A14CAB48A7";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "EF4AF75D-455B-200F-E10F-2684E02F1626";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "2FB92611-4C97-6E09-B586-73A320D1E7BD";
	setAttr -s 3 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -4948.2145148373793 -1337.5000621591296 ;
	setAttr ".tgi[0].vh" -type "double2" 8766.0715059865161 2376.7857351473422 ;
	...
	setAttr ".tgi[0].ni[5].x" 2852.857177734375;
	setAttr ".tgi[0].ni[5].y" 1025.7142333984375;
	...
	setAttr ".tgi[0].ni[10].x" 1624.2857666015625;
	setAttr ".tgi[0].ni[10].y" 611.4285888671875;
	setAttr ".tgi[0].ni[10].nvs" 18304;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -6880.9525332753637 -3140.4761809914539 ;
	setAttr ".tgi[1].vh" -type "double2" 6833.3334875485325 573.80961631501759 ;
	setAttr -s 12 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -648.45257568359375;
	setAttr ".tgi[1].ni[0].y" -769.3531494140625;
	setAttr ".tgi[1].ni[0].nvs" 18305;
	setAttr ".tgi[1].ni[1].x" 922.22100830078125;
	...
	setAttr ".tgi[1].ni[6].x" -994.45611572265625;
	setAttr ".tgi[1].ni[6].y" -1771.93798828125;
	setAttr ".tgi[1].ni[6].nvs" 18304;
	setAttr ".tgi[1].ni[7].x" -356.53414916992188;
	setAttr ".tgi[1].ni[7].y" -1413.94384765625;
	setAttr ".tgi[1].ni[7].nvs" 18305;
	setAttr ".tgi[1].ni[8].x" -40.22406005859375;
	setAttr ".tgi[1].ni[8].y" -994.9063720703125;
	...
	setAttr ".tgi[1].ni[11].x" -689.6279296875;
	setAttr ".tgi[1].ni[11].y" -1527.160400390625;
	setAttr ".tgi[1].ni[11].nvs" 18305;
	setAttr ".tgi[2].tn" -type "string" "Untitled_3";
	setAttr ".tgi[2].vl" -type "double2" -104.0912538530079 -1316.641840494291 ;
	setAttr ".tgi[2].vh" -type "double2" 980.78266529693008 -388.07043796858892 ;
	setAttr -s 4 ".tgi[2].ni";
	setAttr ".tgi[2].ni[0].x" 628.5714111328125;
	setAttr ".tgi[2].ni[0].y" -902.85711669921875;
	setAttr ".tgi[2].ni[0].nvs" 18304;
	setAttr ".tgi[2].ni[1].x" 731.0924072265625;
	setAttr ".tgi[2].ni[1].y" -744.28570556640625;
	setAttr ".tgi[2].ni[1].nvs" 18305;
	setAttr ".tgi[2].ni[2].x" 350.84033203125;
	setAttr ".tgi[2].ni[2].y" -675.378173828125;
	setAttr ".tgi[2].ni[2].nvs" 18304;
	setAttr ".tgi[2].ni[3].x" -10.924368858337402;
	setAttr ".tgi[2].ni[3].y" -761.93280029296875;
...
connectAttr "root_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[7].dn"
		;
connectAttr "main.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[8].dn";
connectAttr "root_initLoc.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[9].dn";
connectAttr "negate.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[10].dn";
...
connectAttr "main.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[10].dn";
connectAttr "mirror_condition_2.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[11].dn"
		;
connectAttr "root_initLocShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[0].dn"
		;
connectAttr "root_initLoc.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[1].dn";
