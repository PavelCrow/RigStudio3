...
//Name: point.ma
//Last modified: Sat, Feb 24, 2024 03:23:31 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "6673F44A-40B6-B254-6EA7-1CAD1BAA51FB";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -10.561017900188283 8.2023206261725292 -9.1646108076143538 ;
	setAttr ".r" -type "double3" -24.599999999998726 -134.39999999998565 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 16.236430407328058;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "C560A920-46BB-78B0-6FAC-A3B2DECB89EF";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -78.414441645207305 -690.27765606293087 ;
	setAttr ".tgi[0].vh" -type "double2" 1265.2820953951114 506.81376249800923 ;
	...
	setAttr ".tgi[0].ni[2].x" 498.57144165039062;
	setAttr ".tgi[0].ni[2].y" 281.42855834960938;
	setAttr ".tgi[0].ni[2].nvs" 18304;
	setAttr ".tgi[0].ni[3].x" 650;
	...
	setAttr ".tgi[0].ni[6].x" 651.4285888671875;
	setAttr ".tgi[0].ni[6].y" -470;
	setAttr ".tgi[0].ni[6].nvs" 18304;
	setAttr ".tgi[0].ni[7].x" 344.28570556640625;
	setAttr ".tgi[0].ni[7].y" -470;
	setAttr ".tgi[0].ni[7].nvs" 18304;
	setAttr ".tgi[0].ni[8].x" 651.4285888671875;
	setAttr ".tgi[0].ni[8].y" -340;
	setAttr ".tgi[0].ni[8].nvs" 18304;
	setAttr ".tgi[0].ni[9].x" 344.28570556640625;
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "87602E02-46D5-5C18-C0A0-2583D0D041E5";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 1133.3844586396083 -73.190086135435024 ;
	setAttr ".tgi[0].vh" -type "double2" 1947.6258718937133 180.39101102780134 ;
	setAttr -s 3 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 1291.4285888671875;
...
connectAttr "materialInfo1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn";
