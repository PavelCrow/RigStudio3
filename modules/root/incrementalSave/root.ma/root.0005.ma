...
//Name: root.ma
//Last modified: Sun, Mar 03, 2024 12:59:42 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "71DF6C05-4C9D-569D-EFBB-21B9894FA879";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.8555505000264052 8.3972669473119517 11.200631234213784 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 15.174186267160467;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "CAA5DE53-43C1-6101-A96D-B3AAAB93DDCB";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "B13DAD97-4830-B124-559D-ECAA9A86371C";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0314797C-4FA5-910B-23B2-059BD55C54CD";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "FE6F42A2-4617-1E63-F0B4-07824D11F5D6";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B1C898A8-4D66-150E-519A-63857CB0D58D";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "3F38D4AB-4A7B-FD7C-1540-E18D185DD802";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 459.52379126397449 47.48552485803917 ;
	setAttr ".tgi[0].vh" -type "double2" 2114.2856302715518 1584.6572674292902 ;
	...
	setAttr ".tgi[0].ni[2].x" 1823.175537109375;
	setAttr ".tgi[0].ni[2].y" 922.850341796875;
	setAttr ".tgi[0].ni[2].nvs" 18305;
	setAttr ".tgi[0].ni[3].x" 1487.5869140625;
	setAttr ".tgi[0].ni[3].y" 943.16876220703125;
	...
	setAttr ".tgi[1].vl" -type "double2" -759.21494863124735 -886.63628782843784 ;
	setAttr ".tgi[1].vh" -type "double2" 585.94766914966908 362.93686310674588 ;
	setAttr -s 6 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -644.28570556640625;
	setAttr ".tgi[1].ni[0].y" -184.28572082519531;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" 277.14285278320312;
	setAttr ".tgi[1].ni[1].y" -184.28572082519531;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" -30;
	setAttr ".tgi[1].ni[2].y" -262.85714721679688;
	setAttr ".tgi[1].ni[2].nvs" 18304;
	setAttr ".tgi[1].ni[3].x" 277.14285278320312;
	setAttr ".tgi[1].ni[3].y" -285.71429443359375;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" -337.14285278320312;
	setAttr ".tgi[1].ni[4].y" -234.28572082519531;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" -644.28570556640625;
	setAttr ".tgi[1].ni[5].y" -285.71429443359375;
...
connectAttr "root_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn";
connectAttr "root_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
