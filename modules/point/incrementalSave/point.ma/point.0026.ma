...
//Name: point.ma
//Last modified: Sun, May 12, 2024 04:39:17 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "09627542-4242-B02E-B7EF-7ABD4C3262BA";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.3705256618378741 9.0248991377738079 13.687822747929417 ;
	setAttr ".r" -type "double3" -29.999999999665391 -333.60000000002157 1.7754342538791706e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 17.788266329478304;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "F9DE6704-4F9D-96ED-6557-41B08553F601";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	...
	setAttr ".tgi[1].vl" -type "double2" -1741.229022102099 -1848.2328766027956 ;
	setAttr ".tgi[1].vh" -type "double2" 22.107841127568854 328.8478316304811 ;
	setAttr -s 11 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -1238.067138671875;
	setAttr ".tgi[1].ni[0].y" -1029.7899169921875;
	setAttr ".tgi[1].ni[0].nvs" 18305;
	setAttr ".tgi[1].ni[1].x" -345.71429443359375;
	setAttr ".tgi[1].ni[1].y" -602.85711669921875;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" -1549.3231201171875;
	setAttr ".tgi[1].ni[2].y" -961.98040771484375;
	setAttr ".tgi[1].ni[2].nvs" 18305;
	setAttr ".tgi[1].ni[3].x" -1574.2857666015625;
	setAttr ".tgi[1].ni[3].y" -595.71429443359375;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" -1905.7142333984375;
	setAttr ".tgi[1].ni[4].y" -660;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" -2212.857177734375;
	setAttr ".tgi[1].ni[5].y" -631.4285888671875;
	setAttr ".tgi[1].ni[5].nvs" 18304;
	setAttr ".tgi[1].ni[6].x" -1574.2857666015625;
	setAttr ".tgi[1].ni[6].y" -754.28570556640625;
	setAttr ".tgi[1].ni[6].nvs" 18304;
	setAttr ".tgi[1].ni[7].x" -910.42669677734375;
	setAttr ".tgi[1].ni[7].y" -879.1585693359375;
	setAttr ".tgi[1].ni[7].nvs" 18305;
	setAttr ".tgi[1].ni[8].x" -25.601085662841797;
	setAttr ".tgi[1].ni[8].y" -625.7275390625;
	setAttr ".tgi[1].ni[8].nvs" 18305;
	setAttr ".tgi[1].ni[9].x" -931.82745361328125;
	setAttr ".tgi[1].ni[9].y" -485.27206420898438;
	setAttr ".tgi[1].ni[9].nvs" 18304;
	setAttr ".tgi[1].ni[10].x" -652.85711669921875;
	setAttr ".tgi[1].ni[10].y" -602.85711669921875;
...
connectAttr "mute_mod_scaleX.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn";
...
connectAttr "root_ctrJoint_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn"
		;
connectAttr "root_ctrJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn";
connectAttr "negate.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[6].dn";
connectAttr "mirror_composeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[7].dn"
		;
...
connectAttr "root_multMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[10].dn"
		;
