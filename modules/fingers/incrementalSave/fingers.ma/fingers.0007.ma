...
//Name: fingers.ma
//Last modified: Tue, Jun 18, 2024 04:21:28 AM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "37AD1F52-4C34-4FA1-FEF7-52A7FECDFE08";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.3827125380590184 1.8339407248342927 0.77561260727166503 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".ncp" 0.001;
	setAttr ".fcp" 50000;
	setAttr ".coi" 2.5400698606779386;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "B6839F90-483E-03AB-02C4-75AA1EE55737";
	setAttr -s 3 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -1238.8587282200733 -764.53958375042419 ;
	setAttr ".tgi[0].vh" -type "double2" -261.60566938672594 143.67288892480622 ;
	setAttr -s 7 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" -1180.84033203125;
	setAttr ".tgi[0].ni[0].y" 56.722682952880859;
	setAttr ".tgi[0].ni[0].nvs" 18305;
	setAttr ".tgi[0].ni[1].x" -954.44207763671875;
	setAttr ".tgi[0].ni[1].y" -253.0341796875;
	setAttr ".tgi[0].ni[1].nvs" 18304;
	setAttr ".tgi[0].ni[2].x" -584.11358642578125;
	setAttr ".tgi[0].ni[2].y" -100.83491516113281;
	setAttr ".tgi[0].ni[2].nvs" 18305;
	setAttr ".tgi[0].ni[3].x" -950.80029296875;
	setAttr ".tgi[0].ni[3].y" -153.45106506347656;
	setAttr ".tgi[0].ni[3].nvs" 18304;
	setAttr ".tgi[0].ni[4].x" -949.5106201171875;
	setAttr ".tgi[0].ni[4].y" -584.9486083984375;
	setAttr ".tgi[0].ni[4].nvs" 18304;
	setAttr ".tgi[0].ni[5].x" -953.0135498046875;
	setAttr ".tgi[0].ni[5].y" -513.0341796875;
	setAttr ".tgi[0].ni[5].nvs" 18304;
	setAttr ".tgi[0].ni[6].x" -953.0135498046875;
	setAttr ".tgi[0].ni[6].y" -383.0341796875;
...
connectAttr "root_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "pinkyFingerA_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
connectAttr "pinkyFinger_posers_curveShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "pinkyFingerRoot_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "pinkyFingerD_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "pinkyFingerC_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "pinkyFingerB_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[6].dn"
		;
