...
//Name: root.ma
//Last modified: Sat, Apr 06, 2024 04:46:34 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "8D1725B1-4322-0A04-0F55-52913C250454";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.768057694674301 11.139933937339475 14.858920087832622 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 20.130291928289822;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0E074825-496F-1A54-C8E9-81B601EADCDB";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "61A56813-4445-0483-1682-B8B7B393C2FC";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1A5712EF-4D32-2B36-DB02-19A23B3F4D5A";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F4C3F484-4D49-D1E7-DC10-64B3AAF3329B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E967D5C5-405D-BE92-7D3C-E7B46BC2974B";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "CBFDB086-4664-D100-3875-18BA07F8F095";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 459.52379126397466 -28.540128017208907 ;
	setAttr ".tgi[0].vh" -type "double2" 2115.4761064147228 1659.4924441613675 ;
	setAttr -s 7 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 819.11871337890625;
	setAttr ".tgi[0].ni[0].y" 497.68133544921875;
	setAttr ".tgi[0].ni[0].nvs" 18304;
	setAttr ".tgi[0].ni[1].x" 1188.5714111328125;
	setAttr ".tgi[0].ni[1].y" 842.93115234375;
	...
	setAttr ".tgi[0].ni[4].x" 1487.5869140625;
	setAttr ".tgi[0].ni[4].y" 943.16876220703125;
	...
	setAttr ".tgi[1].vl" -type "double2" -398.4169543771286 -808.38701488614288 ;
	setAttr ".tgi[1].vh" -type "double2" 318.34690922129971 -77.73750448368601 ;
	setAttr -s 3 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -8.5714282989501953;
	setAttr ".tgi[1].ni[0].y" -297.14285278320312;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" -325.63259887695312;
	setAttr ".tgi[1].ni[1].y" -354.66909790039062;
	setAttr ".tgi[1].ni[1].nvs" 18305;
	setAttr ".tgi[1].ni[2].x" -8.5714282989501953;
	setAttr ".tgi[1].ni[2].y" -427.14285278320312;
...
connectAttr "mirror_condition.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "root_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "root_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[5].dn";
connectAttr "root_ctrJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[6].dn";
connectAttr "root_group.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn";
connectAttr "root_connector.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn";
