...
//Name: head.ma
//Last modified: Thu, Aug 29, 2024 01:25:34 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "911C608D-4074-1C89-14A8-028F10247213";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.1810446984868896 4.4270719636758882 9.20930216375268 ;
	setAttr ".r" -type "double3" -21.000000000003773 -336.79999999992185 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C346435C-49B4-2E42-EAEC-2FB8E7C47FD2";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "E2EB34DF-45D8-2421-B478-A2909114686F";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A52A5336-42C4-314D-2D35-0FB0F10173BC";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A7A9E241-4083-DA5E-0B79-E5AB259DFF2B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "23DCB072-4785-7A12-F2F3-838C658E8B19";
