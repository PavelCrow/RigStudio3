...
//Name: point.ma
//Last modified: Sat, Mar 02, 2024 04:10:46 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "367383DB-4E72-F376-7518-ADADE43CDDB7";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 12.752139722927925 7.9154436217269044 -5.8923157810428695 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "742250C1-41A8-1FD6-F42A-12AD332897A4";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "2FB1AE8D-4E14-B01B-BA77-559963A1B52E";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D832E1D9-4149-E4EC-0ECB-4B97A09B969A";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "33E42376-4853-1234-74FF-4F9155220E32";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "003BF8CE-468D-4B95-4647-FDAE573A5EC5";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "88018051-4F05-46B1-58E2-47A3044A3D38";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -1436.172104103809 78.571425449287233 ;
	setAttr ".tgi[0].vh" -type "double2" 4009.9815256393358 1553.5713668380556 ;
	...
	setAttr ".tgi[0].ni[6].x" 1487.5869140625;
	setAttr ".tgi[0].ni[6].y" 943.16876220703125;
	setAttr ".tgi[0].ni[6].nvs" 18305;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -1187.9788786547469 -586.26533550838224 ;
	setAttr ".tgi[1].vh" -type "double2" -80.074541890107866 455.39515443064136 ;
	setAttr -s 6 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" 272.85714721679688;
	setAttr ".tgi[1].ni[0].y" 142.85714721679688;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" -341.42855834960938;
	setAttr ".tgi[1].ni[1].y" 142.85714721679688;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" -1324.6466064453125;
	setAttr ".tgi[1].ni[2].y" 130.13136291503906;
	setAttr ".tgi[1].ni[2].nvs" 18305;
	setAttr ".tgi[1].ni[3].x" -648.5714111328125;
	setAttr ".tgi[1].ni[3].y" 142.85714721679688;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" -955.71429443359375;
	setAttr ".tgi[1].ni[4].y" 142.85714721679688;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" -34.285713195800781;
...
connectAttr "root_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[6].dn"
		;
connectAttr "root_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn";
