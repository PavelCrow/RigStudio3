...
//Name: foot2.ma
//Last modified: Sat, Jun 15, 2024 06:19:57 AM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "4B5D946E-489C-3CDB-F005-33B6BE79CC8A";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.4929277704127735 4.1578024417435415 2.9747334535464258 ;
	setAttr ".r" -type "double3" -25.200000000000927 67.200000000000529 -8.2075529156985364e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 8.8027885570399231;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.9039699318713943 0.40975736613002611 -0.11182859307655944 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6AFDE1F0-4D01-FB1F-8A3F-33909289E901";
	setAttr -s 23 ".lnk";
	setAttr -s 23 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "C016905B-49A5-CC4C-ED1D-039414336BF0";
createNode displayLayer -n "defaultLayer";
	rename -uid "19CE01F8-4DF6-369B-03C9-E4ACC39F3E53";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "299967E4-4037-7E49-6BC6-9391B591C243";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "D26F8501-41DB-5A41-D55D-1AAF160536EB";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "7623D8B8-4D3A-CB35-1FF6-B2B05463D5D1";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "ECD9A77B-4528-A16D-DAC1-61BA3F121D8E";
	setAttr -s 3 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -434.52379225738503 -2083.0709847433468 ;
	setAttr ".tgi[0].vh" -type "double2" 3726.1903281249765 1790.2138535233003 ;
	...
	setAttr ".tgi[0].ni[5].x" 988.5714111328125;
	...
	setAttr ".tgi[0].ni[11].x" 1627.8299560546875;
	setAttr ".tgi[0].ni[11].y" -187.4549560546875;
	setAttr ".tgi[0].ni[11].nvs" 18304;
	setAttr ".tgi[0].ni[12].x" 670;
	setAttr ".tgi[0].ni[12].y" -107.14286041259766;
	setAttr ".tgi[0].ni[12].nvs" 18304;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" 1891.6665914985904 -1414.863846373941 ;
	setAttr ".tgi[1].vh" -type "double2" 2891.6665517621618 -483.94560198367412 ;
	setAttr -s 7 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" 2262.857177734375;
	setAttr ".tgi[1].ni[0].y" -564.28570556640625;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" 2262.857177734375;
	setAttr ".tgi[1].ni[1].y" -361.42855834960938;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" 2262.016845703125;
	setAttr ".tgi[1].ni[2].y" -666.55462646484375;
	...
	setAttr ".tgi[1].ni[4].y" -795.71429443359375;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" 2262.857177734375;
	setAttr ".tgi[1].ni[5].y" -462.85714721679688;
	...
	setAttr ".tgi[2].vl" -type "double2" 1252.0354792202359 -1806.2868618012103 ;
	setAttr ".tgi[2].vh" -type "double2" 2249.5144428383433 -877.71545927550642 ;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -k on ".fzn";
	setAttr -av -k on ".ihi";
...
connectAttr "mainPoser_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "multiplyDivide3.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[5].dn";
...
connectAttr "toeBall_toeTip_distance.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[10].dn"
		;
connectAttr "ik_toe_upv.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[11].dn";
connectAttr "mod.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[12].dn";
connectAttr "root_poserOrient_aimConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn"
		;
connectAttr "toeTip_poserOrient_aimConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn"
		;
...
connectAttr "toe_poserOrient_aimConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn"
		;
