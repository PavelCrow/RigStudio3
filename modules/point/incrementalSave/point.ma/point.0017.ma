...
//Name: point.ma
//Last modified: Sat, Mar 02, 2024 04:03:45 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "FD150A7E-4572-7CC6-7796-0983761C602B";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 12.420934179983803 7.7098593935629012 -5.7392773349576229 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 15.705439888767314;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "7683D440-45F2-7859-C7ED-6B8D6F701CF7";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	...
	setAttr ".tgi[1].vl" -type "double2" -1882.1885698971912 -314.28570179712261 ;
	setAttr ".tgi[1].vh" -type "double2" 1502.4266802256677 602.38092844448511 ;
