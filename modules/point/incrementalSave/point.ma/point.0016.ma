...
//Name: point.ma
//Last modified: Sat, Feb 24, 2024 04:12:48 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "1CFD1AF3-4906-050E-5DB0-DCBAE099F440";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 12.098330888430738 7.5096147113406237 -5.5902136870415706 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 15.297529619701661;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2F31D8AD-41E1-4789-2514-29B615AD788F";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "FC3530CA-4B82-1192-61F3-60A6BCCE97C6";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "47F5A7DD-44F2-F8EF-9176-DFB164DCAFBC";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "958DEF8C-47C7-46F8-255B-809C8F9CCFC8";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "9AB2C9A8-4DC0-95C3-B190-DDBCB7377936";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "08B5C292-47A5-EA5C-6DDF-E1984D336F17";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	...
	setAttr ".tgi[1].vl" -type "double2" -704.76187675718393 -313.53127782616315 ;
	setAttr ".tgi[1].vh" -type "double2" 323.80951094248985 602.81698061669647 ;
...
connectAttr "root_ctrJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn";
