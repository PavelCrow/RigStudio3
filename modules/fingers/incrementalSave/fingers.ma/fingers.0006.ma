...
//Name: fingers.ma
//Last modified: Tue, Jun 18, 2024 04:18:08 AM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "516E66E5-4B34-ADB6-68B0-1BB4A9908D57";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.1912832501762187 1.5981526671253594 0.83290258792508787 ;
	setAttr ".r" -type "double3" -55.800000000110231 61.199999999979219 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".ncp" 0.001;
	setAttr ".fcp" 50000;
	setAttr ".coi" 2.2662775319598252;
...
createNode nurbsCurve -n "thumbFinger_posers_curveShape" -p "thumbFinger_posers_curve";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		0.50025763925571942 0 0.70039445406327239
...
createNode nurbsCurve -n "indexFinger_posers_curveShape" -p "indexFinger_posers_curve";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		;
createNode transform -n "indexFinger_posers_curve1";
	rename -uid "E2654C8D-46ED-F2C8-2075-7DACF7A6214B";
createNode nurbsCurve -n "indexFinger_posers_curve1Shape" -p "indexFinger_posers_curve1";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "B62FE584-4FA1-9FC6-B5F8-F080B909BCF6";
	setAttr -s 3 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -1295.2870878889469 -941.11442698523115 ;
	setAttr ".tgi[0].vh" -type "double2" -296.12745204907355 -12.543024459528738 ;
	setAttr -s 7 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" -1129.8319091796875;
	setAttr ".tgi[0].ni[0].y" -397.56301879882812;
	setAttr ".tgi[0].ni[0].nvs" 18304;
	setAttr ".tgi[0].ni[1].x" -1139.824951171875;
	setAttr ".tgi[0].ni[1].y" -169.68588256835938;
	setAttr ".tgi[0].ni[1].nvs" 18304;
	setAttr ".tgi[0].ni[2].x" -1128.4874267578125;
	setAttr ".tgi[0].ni[2].y" -572.2689208984375;
	setAttr ".tgi[0].ni[2].nvs" 18304;
	setAttr ".tgi[0].ni[3].x" -1135.462158203125;
	setAttr ".tgi[0].ni[3].y" -306.218505859375;
	setAttr ".tgi[0].ni[3].nvs" 18304;
	setAttr ".tgi[0].ni[4].x" -1118.655517578125;
	setAttr ".tgi[0].ni[4].y" -468.65545654296875;
	setAttr ".tgi[0].ni[4].nvs" 18304;
	setAttr ".tgi[0].ni[5].x" -1180.84033203125;
	setAttr ".tgi[0].ni[5].y" 56.722682952880859;
	setAttr ".tgi[0].ni[5].nvs" 18305;
	setAttr ".tgi[0].ni[6].x" -762.18487548828125;
	setAttr ".tgi[0].ni[6].y" -56.134452819824219;
	setAttr ".tgi[0].ni[6].nvs" 18305;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" 322.89273780109545 -5325.8972462227257 ;
	setAttr ".tgi[1].vh" -type "double2" 1857.3655919468249 -3899.8312211335492 ;
...
connectAttr "indexFingerD_poser_locShape.wp" "indexFinger_posers_curveShape.cp[5]"
		;
connectAttr "root_poser_locShape.wp" "indexFinger_posers_curve1Shape.cp[0]";
connectAttr "middleFingerRoot_poserOrientShape.wp" "indexFinger_posers_curve1Shape.cp[1]"
		;
connectAttr "middleFingerA_poser_locShape.wp" "indexFinger_posers_curve1Shape.cp[2]"
		;
connectAttr "middleFingerB_poser_locShape.wp" "indexFinger_posers_curve1Shape.cp[3]"
		;
connectAttr "middleFingerC_poser_locShape.wp" "indexFinger_posers_curve1Shape.cp[4]"
		;
connectAttr "middleFingerD_poser_locShape.wp" "indexFinger_posers_curve1Shape.cp[5]"
		;
...
connectAttr "middleFingerB_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "middleFingerRoot_poserOrientShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
connectAttr "middleFingerD_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "middleFingerA_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "middleFingerC_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "root_poser_locShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "indexFinger_posers_curve1Shape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[6].dn"
		;
