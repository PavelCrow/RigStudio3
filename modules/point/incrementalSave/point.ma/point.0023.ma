...
//Name: point.ma
//Last modified: Sat, Apr 06, 2024 04:46:09 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "01F8F2C1-4A64-AED2-24E7-89B0DCA82ABF";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "03834B61-41D2-9DB5-E7DE-7996C74B0F64";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "D5585839-4C5D-45FF-026C-3F8400AFB0B3";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B21435D7-42DD-D32B-3D15-729A836DC2A2";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "EBBC41F6-464A-4BB7-902E-749E08D9CB19";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "8DE20CCD-442C-ED51-D8EE-169F65E209DB";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "3D3C9B64-4768-FBA8-9E25-F58B7FFE49C4";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 858.67643646749934 347.61903380590837 ;
	setAttr ".tgi[0].vh" -type "double2" 1754.4186977926672 1260.7142356180032 ;
	setAttr ".tgi[0].ni[0].x" 1052.857177734375;
	setAttr ".tgi[0].ni[0].y" 834.28570556640625;
	setAttr ".tgi[0].ni[0].nvs" 18304;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -784.34757280848908 -1049.2336253336287 ;
	setAttr ".tgi[1].vh" -type "double2" -46.580924861395943 -297.17445007390756 ;
	setAttr -s 3 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -778.3155517578125;
	setAttr ".tgi[1].ni[0].y" -565.3304443359375;
	setAttr ".tgi[1].ni[0].nvs" 18305;
	setAttr ".tgi[1].ni[1].x" -400.39065551757812;
	setAttr ".tgi[1].ni[1].y" -448.94845581054688;
	setAttr ".tgi[1].ni[1].nvs" 18305;
	setAttr ".tgi[1].ni[2].x" -416.7249755859375;
	setAttr ".tgi[1].ni[2].y" -692.60809326171875;
...
connectAttr "root_group.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn";
connectAttr "controls.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn";
