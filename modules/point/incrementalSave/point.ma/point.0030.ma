...
//Name: point.ma
//Last modified: Fri, Jun 14, 2024 06:15:50 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "DF64AA06-4315-A4C7-7258-21AC8F0BC285";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.2110720563697952 4.2669990472115629 7.344766289681643 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 8.9783062132711429;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "D63D8FBB-4D88-5FB0-D215-69ACE06461F0";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 1022.7260624635834 311.43332741480828 ;
	setAttr ".tgi[0].vh" -type "double2" 2059.6525788651161 1276.7271779823686 ;
	setAttr -s 5 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 1197.61572265625;
	setAttr ".tgi[0].ni[0].y" 939.49481201171875;
	setAttr ".tgi[0].ni[0].nvs" 18305;
	setAttr ".tgi[0].ni[1].x" 1843.3499755859375;
	setAttr ".tgi[0].ni[1].y" 770.8013916015625;
	setAttr ".tgi[0].ni[1].nvs" 18304;
	setAttr ".tgi[0].ni[2].x" 1505.6322021484375;
	setAttr ".tgi[0].ni[2].y" 822.34197998046875;
	setAttr ".tgi[0].ni[2].nvs" 18305;
	setAttr ".tgi[0].ni[3].x" 1193.2479248046875;
	setAttr ".tgi[0].ni[3].y" 636.17718505859375;
	setAttr ".tgi[0].ni[3].nvs" 18305;
	setAttr ".tgi[0].ni[4].x" 1185.3857421875;
	setAttr ".tgi[0].ni[4].y" 765.55999755859375;
	setAttr ".tgi[0].ni[4].nvs" 18304;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -914.12857848035719 -1664.6804758918292 ;
	setAttr ".tgi[1].vh" -type "double2" 429.9362745378171 -413.46593285469163 ;
...
connectAttr "mainPoser_clusterHandle.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "mainPoserShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn";
connectAttr "mainPoser_clusterHandleCluster.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "mainPoserShapeOrig.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "mainPoser_clusterHandleShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
