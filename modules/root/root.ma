...
//Name: root.ma
//Last modified: Mon, Jul 28, 2025 10:44:56 AM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "A0FA8FAD-4F8A-4F63-D5BF-3DB63DAFFC98";
...
createNode transform -n "root_PH" -p "root_group";
	rename -uid "77D2B823-4B3F-CE4E-D1E1-778C85A09236";
createNode transform -n "root_SN" -p "root_PH";
	rename -uid "B5F3D8CF-4036-174F-853D-78887C74D177";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 12.639052056168518 12.061844825565169 20.104175050271717 ;
	setAttr ".r" -type "double3" -29.400000000000428 -330.79999999999234 9.1089306946256912e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 26.049743569250751;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "9171BA37-48FE-B312-F3B2-E0BCB2D99688";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "0C8CB2CD-4ED5-8BBE-1EE9-4A9398DC34A2";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E576A357-4498-D87B-9C21-21A929D9CA54";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "AF15E1AA-450B-BBF1-6D3A-C3BFBD98C185";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "472188A8-4DA4-4632-F71B-4D8DC3BACB1B";
