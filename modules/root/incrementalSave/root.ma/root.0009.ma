...
//Name: root.ma
//Last modified: Fri, Aug 09, 2024 06:19:46 AM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "013DA520-4FC2-F6CB-E4D4-71A0A02B13C1";
...
createNode joint -n "root2_outJoint" -p "outJoints";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 17.798147440687536 18.338233433838401 24.497043081829059 ;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "A004AE81-4A9D-73FF-5506-2F8DEFE5F161";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	...
	setAttr ".tgi[1].vl" -type "double2" -792.63170379864005 -1817.5653565613754 ;
	setAttr ".tgi[1].vh" -type "double2" 921.73194418196499 -84.379783808795992 ;
	setAttr -s 7 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -128.57142639160156;
	setAttr ".tgi[1].ni[0].y" -422.85714721679688;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" -435.71429443359375;
	setAttr ".tgi[1].ni[1].y" -321.42855834960938;
	setAttr ".tgi[1].ni[1].nvs" 18304;
	setAttr ".tgi[1].ni[2].x" 178.57142639160156;
	setAttr ".tgi[1].ni[2].y" -422.85714721679688;
	setAttr ".tgi[1].ni[2].nvs" 18304;
	setAttr ".tgi[1].ni[3].x" 523.26324462890625;
	setAttr ".tgi[1].ni[3].y" -378.32449340820312;
	setAttr ".tgi[1].ni[3].nvs" 18305;
	setAttr ".tgi[1].ni[4].x" -742.85711669921875;
	setAttr ".tgi[1].ni[4].y" -422.85714721679688;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" -435.71429443359375;
	setAttr ".tgi[1].ni[5].y" -524.28570556640625;
	setAttr ".tgi[1].ni[5].nvs" 18304;
	setAttr ".tgi[1].ni[6].x" -435.71429443359375;
	setAttr ".tgi[1].ni[6].y" -422.85714721679688;
...
connectAttr "root_decomposeMatrix.or" "root2_outJoint.r";
connectAttr "root_decomposeMatrix.ot" "root2_outJoint.t";
...
connectAttr "root_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "root2_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn";
...
connectAttr "root_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn"
		;
connectAttr "root2_outJoint.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[3].dn";
