...
//Name: head.ma
//Last modified: Mon, Jul 28, 2025 10:29:59 AM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "31356381-40FB-A77D-5E32-B2993EA16A6A";
...
createNode transform -n "world_connector" -p "input";
	rename -uid "D7D31EB9-4F7B-50BF-033C-3B9391655C22";
createNode locator -n "world_connectorShape" -p "world_connector";
	rename -uid "123309EC-481C-4660-DE20-55B7943F9A40";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 14;
	setAttr ".los" -type "double3" 0.1 0.1 0.1 ;
...
createNode orientConstraint -n "root_group_orientConstraint1" -p "root_group";
	rename -uid "BAB78326-4871-1A2A-A87E-A8B301FA3187";
	addAttr -dcb 0 -ci true -k true -sn "w0" -ln "root_connectorW0" -dv 1 -min 0 -at "double";
	addAttr -dcb 0 -ci true -k true -sn "w1" -ln "world_connectorW1" -dv 1 -min 0 -at "double";
	setAttr -k on ".nds";
	setAttr -k off ".v";
	setAttr -k off ".tx";
	setAttr -k off ".ty";
	...
	setAttr -k on ".w0";
	setAttr -k on ".w1";
createNode transform -n "root_PH" -p "root_group";
	rename -uid "28FD1667-4EEB-DB2F-E095-EF856734B3BE";
createNode transform -n "root_SN" -p "root_PH";
	rename -uid "6CAAC1E2-4D7B-BFC8-D3D1-F583AF6E432F";
createNode transform -n "root" -p "root_SN";
...
createNode nurbsCurve -n "rootShape" -p "root";
	rename -uid "D12F1F44-4D9D-2CCB-6964-329FB6579959";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 17;
	setAttr ".cc" -type "nurbsCurve" 
		...
		11
		1.4891325479984885 4.9790636086335791 -1.4891325479984854
		-2.4026387899273386e-16 4.9790636086335791 -2.1059514455506707
		-1.4891325479984856 4.9790636086335791 -1.4891325479984856
		-2.1059514455506707 4.9790636086335791 -6.09426088767927e-16
		-1.4891325479984869 4.9790636086335791 1.4891325479984856
		-6.345642705420579e-16 4.9790636086335791 2.1059514455506707
		1.4891325479984854 4.9790636086335791 1.4891325479984863
		2.1059514455506707 4.9790636086335791 1.1319365829647421e-15
		1.4891325479984885 4.9790636086335791 -1.4891325479984854
		-2.4026387899273386e-16 4.9790636086335791 -2.1059514455506707
		-1.4891325479984856 4.9790636086335791 -1.4891325479984856
		;
createNode transform -n "main_group" -p "root";
	rename -uid "6F396B91-4842-341B-CED5-D097F2681FD4";
createNode transform -n "control" -p "main_group";
	rename -uid "58B207EC-4F15-FFEB-989A-BF8B5341D3BA";
	addAttr -ci true -sn "globalOrient" -ln "globalOrient" -min 0 -max 1 -at "double";
	setAttr -l on -k off ".v";
	...
	setAttr -k on ".globalOrient";
createNode nurbsCurve -n "controlShape" -p "control";
	rename -uid "7F738FE4-4671-E558-E4D1-E4A5BFF48223";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 20;
	setAttr ".cc" -type "nurbsCurve" 
		...
		4 0 1 2 3
		4
		3.2580848399233138 2.6322520840616144 -5.6556249665645716e-17
		3.2580848399233138 3.5287300237961929 -2.5561433961801593e-16
		3.6733122057276151 3.2624290447820647 -2.886826403357506e-16
		3.2580848399233138 2.9961280657679321 -1.3735294826533221e-16
		;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.72071050540313319 7.7495929835262425 22.259432648138066 ;
	setAttr ".r" -type "double3" -18.000000000004047 -357.99999999991593 -1.9890583565230358e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 24.195679276081208;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0 0 0.061501383005705179 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "06043AEA-45DF-396C-500F-73842B25F6FB";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "CF70849C-4C39-7932-1B86-02A70834D4BB";
createNode displayLayer -n "defaultLayer";
	rename -uid "6684CFD7-4C9D-D20C-7922-43B1C9C96070";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C7C52ECC-489E-B706-EA6F-78BA592F2C15";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "540DBD0E-4D29-2095-EE27-C2A177CCBB36";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "CF92AFA8-43B6-0332-402C-78859BBC92EB";
...
createNode reverse -n "reverse1";
	rename -uid "199BB295-4204-3EDB-D929-0F8E218EA2E1";
createNode objectSet -n "skinJointsSet";
	rename -uid "54D8F004-4E92-DE02-A01B-A58147CA7452";
	setAttr ".ihi" 0;
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "B0CF2082-4DAB-2E1E-6886-2480D53C644D";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -188.57142857142858 -197.91666664301403 ;
	setAttr ".tgi[0].vh" -type "double2" 188.57142857142858 196.72619049984314 ;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -354.76189066493384 -829.91688170460554 ;
	setAttr ".tgi[1].vh" -type "double2" 601.19045230131405 170.39309838791684 ;
	setAttr -s 7 ".tgi[1].ni";
	setAttr ".tgi[1].ni[0].x" -36.050731658935547;
	setAttr ".tgi[1].ni[0].y" -377.56732177734375;
	setAttr ".tgi[1].ni[0].nvs" 18304;
	setAttr ".tgi[1].ni[1].x" 135.71427917480469;
	setAttr ".tgi[1].ni[1].y" -35.714286804199219;
	setAttr ".tgi[1].ni[1].nvs" 18305;
	setAttr ".tgi[1].ni[2].x" 361.21652221679688;
	setAttr ".tgi[1].ni[2].y" -191.98619079589844;
	setAttr ".tgi[1].ni[2].nvs" 18305;
	setAttr ".tgi[1].ni[3].x" -171.42857360839844;
	setAttr ".tgi[1].ni[3].y" -137.14285278320312;
	setAttr ".tgi[1].ni[3].nvs" 18304;
	setAttr ".tgi[1].ni[4].x" -171.42857360839844;
	setAttr ".tgi[1].ni[4].y" 65.714286804199219;
	setAttr ".tgi[1].ni[4].nvs" 18304;
	setAttr ".tgi[1].ni[5].x" -78.571426391601562;
	setAttr ".tgi[1].ni[5].y" -544.28570556640625;
	setAttr ".tgi[1].ni[5].nvs" 18304;
	setAttr ".tgi[1].ni[6].x" -292.69192504882812;
	setAttr ".tgi[1].ni[6].y" -239.49348449707031;
...
connectAttr "root_group_orientConstraint1.crx" "root_group.rx";
connectAttr "root_group_orientConstraint1.cry" "root_group.ry";
connectAttr "root_group_orientConstraint1.crz" "root_group.rz";
connectAttr "root_group.ro" "root_group_orientConstraint1.cro";
connectAttr "root_group.pim" "root_group_orientConstraint1.cpim";
connectAttr "root_connector.r" "root_group_orientConstraint1.tg[0].tr";
connectAttr "root_connector.ro" "root_group_orientConstraint1.tg[0].tro";
connectAttr "root_connector.pm" "root_group_orientConstraint1.tg[0].tpm";
connectAttr "root_group_orientConstraint1.w0" "root_group_orientConstraint1.tg[0].tw"
		;
connectAttr "world_connector.r" "root_group_orientConstraint1.tg[1].tr";
connectAttr "world_connector.ro" "root_group_orientConstraint1.tg[1].tro";
connectAttr "world_connector.pm" "root_group_orientConstraint1.tg[1].tpm";
connectAttr "root_group_orientConstraint1.w1" "root_group_orientConstraint1.tg[1].tw"
		;
connectAttr "reverse1.ox" "root_group_orientConstraint1.w0";
connectAttr "control.globalOrient" "root_group_orientConstraint1.w1";
...
connectAttr "control.globalOrient" "reverse1.ix";
connectAttr "root_outJoint.iog" "skinJointsSet.dsm" -na;
connectAttr "reverse1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[0].dn";
connectAttr "root_group_orientConstraint1.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[1].dn"
		;
connectAttr "root_group.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[2].dn";
connectAttr "world_connector.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[3].dn";
connectAttr "root_connector.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[4].dn";
connectAttr "controlShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[5].dn";
connectAttr "control.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[6].dn";
