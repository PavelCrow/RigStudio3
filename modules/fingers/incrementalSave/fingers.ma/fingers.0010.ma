...
//Name: fingers.ma
//Last modified: Tue, Jun 18, 2024 04:32:32 AM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "1F26D58E-4E0F-1E0D-1122-07A56D613058";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.5416725290968585 2.3401504993732454 1.2819173237636328 ;
	setAttr ".r" -type "double3" -51.00000000012119 32.8 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".ncp" 0.001;
	setAttr ".fcp" 50000;
	setAttr ".coi" 2.7111277736048125;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "90A8605C-4D08-C527-6EA7-369448A48453";
	setAttr -s 3 ".tgi";
	...
	setAttr ".tgi[2].vl" -type "double2" 1233.9024931328588 -2218.3109899346118 ;
	setAttr ".tgi[2].vh" -type "double2" 2693.3434115014502 -861.97607420938743 ;
	setAttr -s 12 ".tgi[2].ni";
	setAttr ".tgi[2].ni[0].x" 1330;
	setAttr ".tgi[2].ni[0].y" -1125.7142333984375;
	setAttr ".tgi[2].ni[0].nvs" 18304;
	setAttr ".tgi[2].ni[1].x" 2305.71435546875;
	setAttr ".tgi[2].ni[1].y" -1661.4285888671875;
	setAttr ".tgi[2].ni[1].nvs" 18304;
	setAttr ".tgi[2].ni[2].x" 1000.7630004882812;
	setAttr ".tgi[2].ni[2].y" -1200.86669921875;
	setAttr ".tgi[2].ni[2].nvs" 18305;
	setAttr ".tgi[2].ni[3].x" 1647.9034423828125;
	setAttr ".tgi[2].ni[3].y" -1377.9019775390625;
	setAttr ".tgi[2].ni[3].nvs" 18305;
	setAttr ".tgi[2].ni[4].x" 2305.71435546875;
	setAttr ".tgi[2].ni[4].y" -1531.4285888671875;
	setAttr ".tgi[2].ni[4].nvs" 18304;
	setAttr ".tgi[2].ni[5].x" 2262.857177734375;
	setAttr ".tgi[2].ni[5].y" -995.71429443359375;
	setAttr ".tgi[2].ni[5].nvs" 18304;
	setAttr ".tgi[2].ni[6].x" 2262.857177734375;
	setAttr ".tgi[2].ni[6].y" -1097.142822265625;
	setAttr ".tgi[2].ni[6].nvs" 18304;
	setAttr ".tgi[2].ni[7].x" 2262.857177734375;
	setAttr ".tgi[2].ni[7].y" -1198.5714111328125;
	setAttr ".tgi[2].ni[7].nvs" 18304;
	setAttr ".tgi[2].ni[8].x" 2262.857177734375;
	setAttr ".tgi[2].ni[8].y" -1300;
	setAttr ".tgi[2].ni[8].nvs" 18304;
	setAttr ".tgi[2].ni[9].x" 1648.5714111328125;
	setAttr ".tgi[2].ni[9].y" -1124.2857666015625;
	setAttr ".tgi[2].ni[9].nvs" 18305;
	setAttr ".tgi[2].ni[10].x" 2262.857177734375;
	setAttr ".tgi[2].ni[10].y" -1401.4285888671875;
	setAttr ".tgi[2].ni[10].nvs" 18304;
	setAttr ".tgi[2].ni[11].x" 2003.5849609375;
	setAttr ".tgi[2].ni[11].y" -1199.798828125;
...
connectAttr "indexFingerC_poser.msg" "MayaNodeEditorSavedTabsInfo.tgi[1].ni[74].dn"
		;
connectAttr "mainPoser_decomposeMatrix.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[0].dn"
		;
connectAttr "mainPoserShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[1].dn";
connectAttr "mainPoser.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[2].dn";
connectAttr "multiplyDivide8.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[3].dn";
connectAttr "mainPoserShapeOrig.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[4].dn"
		;
connectAttr "pinkyFinger_posers_sweepShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[5].dn"
		;
connectAttr "thumbFinger_posers_sweepShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[6].dn"
		;
connectAttr "indexFinger_posers_sweepShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[7].dn"
		;
connectAttr "middleFinger_posers_sweepShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[8].dn"
		;
connectAttr "multDoubleLinear26.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[9].dn"
		;
connectAttr "ringFinger_posers_sweepShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[10].dn"
		;
connectAttr "sweepMeshCreator2.msg" "MayaNodeEditorSavedTabsInfo.tgi[2].ni[11].dn"
		;
