...
//Name: point.ma
//Last modified: Sat, Feb 24, 2024 03:30:19 PM
//Codeset: 1251
requires maya "2022";
...
fileInfo "UUID" "6EEAB3AD-4A64-9DD5-0FA4-BEA4DFBEFC7D";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -9.7487614081220624 11.694702819658515 -16.317783657406274 ;
	setAttr ".r" -type "double3" -29.999999999982155 -148.79999999991708 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 22.667741401112607;
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "440DA763-44A7-4D65-11C8-4390A42AF0B5";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 459.86664754496786 82.424064755950582 ;
	setAttr ".tgi[0].vh" -type "double2" 2111.0782982239807 1553.4789069523472 ;
	setAttr -s 7 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 877.3648681640625;
	setAttr ".tgi[0].ni[0].y" 726.6024169921875;
	setAttr ".tgi[0].ni[0].nvs" 18304;
	setAttr ".tgi[0].ni[1].x" 881.4285888671875;
